"""Generic LSR-v2 supervised paper integrated operation readiness execution.

29.4.4u-52 consumes u-51's integrated operation readiness preflight artifact
...
PROMPT = "29.4.4u-52"
EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_EXECUTION"
READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_EXECUTION_READY"
KEEP_DIAGNOSTIC_DECISION = "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_EXECUTION_NOT_READY"
U51_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_EXECUTION_SCAFFOLD_READY"
...
INTEGRATED_OPERATION_READINESS_EXECUTION_STAGES: Tuple[str, ...] = (
    "load_generic_integrated_operation_readiness_execution_scaffold_report",
    "verify_integrated_operation_readiness_execution_scaffold_model_ready",
    "verify_integrated_operation_readiness_execution_scaffold_was_blocked",
    ...
    "verify_integrated_operation_execution_requires_complete_runtime_lifecycle_evidence",
    "verify_integrated_operation_operator_gate_required_but_absent",
    "verify_runtime_values_required_but_absent",
    "verify_integrated_operation_execution_patch_current_step_but_runtime_still_blocked",
    ...
    "map_integrated_operation_readiness_execution_gate",
    "publish_generic_integrated_operation_readiness_execution_artifact",
)

BLOCKED_UNTIL_RUNTIME_INTEGRATED_OPERATION_EXECUTION_PREREQUISITES: Tuple[str, ...] = (
...
REQUIRED_SOURCE_MARKERS: Tuple[Tuple[str, Tuple[str, ...]], ...] = (
    (
        ...
        (
            ...
            "generic_integrated_operation_readiness_execution_scaffold_ready",
        ),
    ),
...
class Settings:
    ...
    data_dir: str = "data"
    report_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_readiness_execution_report.json"
    jsonl_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_readiness_execution.jsonl"
...
def _build_integrated_operation_readiness_execution_map(
    upstream: Mapping[str, Any], active_env: Mapping[str, str]
) -> Dict[str, Any]:
    source_map = _as_dict(upstream.get("generic_supervised_paper_integrated_operation_readiness_execution_scaffold_map"))
    source_gate = _as_dict(source_map.get("integrated_operation_readiness_execution_scaffold_gate_model"))
    dry_run_order_intent_payload = _as_dict(source_map.get("dry_run_order_intent_payload")) or _default_order_intent_payload()

    preflight_report_ready = upstream.get("decision") == U51_READY_DECISION
    preflight_ready = _bool_from_upstream(upstream, "generic_supervised_paper_integrated_operation_readiness_execution_scaffold_ready")
    preflight_model_ready = _bool_from_upstream(upstream, "generic_integrated_operation_readiness_execution_scaffold_model_ready")
    preflight_patch_ready = _bool_from_upstream(upstream, "generic_integrated_operation_readiness_execution_scaffold_patch_ready")
    preflight_allowed = _bool_from_upstream(upstream, "generic_integrated_operation_readiness_execution_scaffold_allowed")
    ...
    gate_checks: Tuple[Tuple[bool, str], ...] = (
        (preflight_report_ready, "integrated_operation_readiness_execution_scaffold_report_not_ready"),
        (preflight_ready, "integrated_operation_readiness_execution_scaffold_not_ready"),
        (preflight_model_ready, "integrated_operation_readiness_execution_scaffold_model_not_ready"),
        (preflight_patch_ready, "integrated_operation_readiness_execution_scaffold_patch_not_ready"),
        (preflight_allowed, "integrated_operation_readiness_execution_scaffold_not_allowed"),
    ...
    gate_model = {
        "integrated_operation_readiness_execution_scaffold_report_ready": preflight_report_ready,
        "integrated_operation_readiness_execution_scaffold_report_required": True,
        "integrated_operation_readiness_execution_scaffold_ready": preflight_ready,
        "integrated_operation_readiness_execution_scaffold_model_ready": preflight_model_ready,
        "integrated_operation_readiness_execution_scaffold_patch_ready": preflight_patch_ready,
        "integrated_operation_readiness_execution_scaffold_allowed": preflight_allowed,
        "integrated_operation_readiness_execution_gate_model_ready": True,
        "integrated_operation_readiness_execution_model_ready": True,
        "integrated_operation_readiness_execution_patch_ready": True,
        "integrated_operation_readiness_execution_conditions_satisfied": scaffold_conditions_satisfied,
        "integrated_operation_readiness_execution_allowed": False,
        "integrated_operation_readiness_execution_blocked_reasons": blocked_reasons,
        ...
        "scheduler_start_allowed_after_integrated_readiness_execution": False,
        "telegram_network_send_allowed_after_integrated_readiness_execution": False,
        "paper_state_mutation_allowed_after_integrated_readiness_execution": False,
        "paper_status_mutation_allowed_after_integrated_readiness_execution": False,
    ...
    context = {
        "blocked_reason": "integrated_operation_readiness_execution_blocked_until_complete_runtime_lifecycle_evidence_operator_gates_and_runtime_still_blocked",
        "integrated_operation_readiness_execution_scaffold_ready": preflight_report_ready and preflight_ready and preflight_model_ready,
        "generic_integrated_operation_readiness_execution_scaffold_allowed": False,
        "generic_integrated_operation_readiness_execution_ready": True,
        "generic_integrated_operation_readiness_execution_allowed": False,
    ...
    return {
        "mode": "generic_supervised_paper_integrated_operation_readiness_execution_controlled",
        "read_only": True,
        ...
        "paper_only": True,
        "preflight_source": "29.4.4u-51",
        "source_integrated_operation_readiness_execution_scaffold_map": source_map,
        ...
        "integrated_operation_readiness_execution_context": context,
        "integrated_operation_readiness_execution_gate_model": gate_model,
        ...
        "stages": [
            ...
            for stage in INTEGRATED_OPERATION_READINESS_EXECUTION_STAGES
        ],
    }
...
def run_generic_supervised_paper_integrated_operation_readiness_execution(
    settings: Settings | None = None,
) -> Dict[str, Any]:
    settings = settings or Settings()
    data_path = settings.data_path
    active_env = _active_lsr_env()
    upstream_path = data_path / "lsr_v2_generic_supervised_paper_integrated_operation_readiness_execution_scaffold_report.json"
    upstream = _read_json(upstream_path)
    upstream_present = bool(upstream)
    upstream_ready = upstream.get("decision") == U51_READY_DECISION and upstream.get(
    ...
    readiness_map = _build_integrated_operation_readiness_execution_map(upstream, active_env)
    gate = _as_dict(readiness_map.get("integrated_operation_readiness_execution_gate_model", {}))
    ready = not blockers and bool(settings.fail_closed)

    diagnostic_count = _safe_int(upstream.get("integrated_operation_readiness_execution_scaffold_diagnostic_count"), 0)
    diagnostic_available = upstream.get("integrated_operation_readiness_execution_scaffold_diagnostic_available") is True
    ...
    report: Dict[str, Any] = {
        ...
        "classification_labels": [
            ...
            "INTEGRATED_OPERATION_READINESS_EXECUTION_CONTROLLED",
            ...
            "NO_BROKER_CALL",
            "FAIL_CLOSED",
            "GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_EXECUTION_READY",
        ],
        "blockers": blockers,
        ...
        "upstream_integrated_operation_readiness_execution_scaffold_report_present": upstream_present,
        "upstream_integrated_operation_readiness_execution_scaffold_ready": upstream_ready,
        "generic_supervised_paper_integrated_operation_readiness_execution_ready": ready,
        "generic_integrated_operation_readiness_execution_ready": ready,
        "generic_integrated_operation_readiness_execution_model_ready": True,
        "generic_integrated_operation_readiness_execution_patch_ready": True,
        "paper_integrated_operation_readiness_execution_ready": ready,
        "integrated_operation_readiness_execution_diagnostic_available": diagnostic_available,
        "integrated_operation_readiness_execution_diagnostic_count": diagnostic_count,
        "integrated_operation_readiness_execution_contract_shape_modelable": contract_shape_modelable,
        "integrated_operation_readiness_execution_required_contract_fields": contract_required,
        "integrated_operation_readiness_execution_present_contract_fields": contract_present,
        "integrated_operation_readiness_execution_missing_contract_fields": contract_missing,
        "generic_supervised_paper_integrated_operation_readiness_execution_map": readiness_map,
        "blocked_until_runtime_integrated_operation_execution_prerequisites": list(
            BLOCKED_UNTIL_RUNTIME_INTEGRATED_OPERATION_EXECUTION_PREREQUISITES
        ),
        ...
        "broker_submit_called_by_generic_integrated_operation_readiness_execution": False,
        "broker_close_called_by_generic_integrated_operation_readiness_execution": False,
        "broker_submit_called_by_upstream_integrated_operation_readiness_execution_scaffold": False,
        "broker_close_called_by_upstream_integrated_operation_readiness_execution_scaffold": False,
        "orders_submitted": 0,
        "positions_opened": 0,
        "positions_closed": 0,
        "paper_integrated_operation_ready": False,
...
__all__ = [
    "READY_DECISION",
    "Settings",
    "run_generic_supervised_paper_integrated_operation_readiness_execution",
]
