"""Generic LSR-v2 supervised paper integrated operation readiness preflight.

29.4.4u-50 consumes u-49's terminal lifecycle handoff execution artifact and
adds a preflight model for a future supervised paper integrated operation. This
patch is intentionally read-only by default and fail-closed. It must not start
integrated operation, hand off terminal lifecycle, mutate paper_state or
paper_status, send Telegram/network messages, start a scheduler, call a broker,
...
and no operator gates. The preflight therefore reports PASS/ready for modelling
...
PROMPT = "29.4.4u-50"
EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_PREFLIGHT"
READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_PREFLIGHT_READY"
KEEP_DIAGNOSTIC_DECISION = "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_PREFLIGHT_NOT_READY"
U49_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_TERMINAL_LIFECYCLE_HANDOFF_EXECUTION_READY"
...
INTEGRATED_OPERATION_READINESS_PREFLIGHT_STAGES: Tuple[str, ...] = (
    "load_generic_terminal_lifecycle_handoff_execution_report",
    "verify_terminal_lifecycle_handoff_execution_model_ready",
    "verify_terminal_lifecycle_handoff_execution_was_blocked",
    ...
    "verify_integrated_operation_requires_complete_runtime_lifecycle_evidence",
    ...
    "map_integrated_operation_readiness_preflight_gate",
    "publish_generic_integrated_operation_readiness_preflight_artifact",
)

BLOCKED_UNTIL_RUNTIME_INTEGRATED_OPERATION_PREREQUISITES: Tuple[str, ...] = (
...
class Settings:
    ...
    data_dir: str = "data"
    report_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_readiness_preflight_report.json"
    jsonl_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_readiness_preflight.jsonl"
...
def _candidate_examples(upstream: Mapping[str, Any]) -> List[Any]:
    examples = _as_list(upstream.get("candidate_diagnostic_examples"))
    return examples[:5]
...
def _build_integrated_operation_readiness_preflight_map(
    upstream: Mapping[str, Any], active_env: Mapping[str, str]
) -> Dict[str, Any]:
    source_map = _as_dict(upstream.get("generic_supervised_paper_terminal_lifecycle_handoff_execution_map"))
    source_gate = _as_dict(source_map.get("terminal_lifecycle_handoff_execution_gate_model"))
    dry_run_order_intent_payload = _as_dict(source_map.get("dry_run_order_intent_payload")) or _default_order_intent_payload()

    terminal_execution_report_ready = upstream.get("decision") == U49_READY_DECISION
    terminal_execution_model_ready = _bool_from_upstream(upstream, "generic_terminal_lifecycle_handoff_execution_model_ready")
    terminal_execution_patch_ready = _bool_from_upstream(upstream, "generic_terminal_lifecycle_handoff_execution_patch_ready")
    terminal_execution_allowed = _bool_from_upstream(upstream, "generic_terminal_lifecycle_handoff_execution_allowed")
    terminal_handoff_ready = _bool_from_upstream(upstream, "paper_terminal_lifecycle_handoff_ready")
    ...
    gate_checks: Tuple[Tuple[bool, str], ...] = (
        (terminal_execution_report_ready, "terminal_lifecycle_handoff_execution_report_not_ready"),
        (terminal_execution_model_ready, "terminal_lifecycle_handoff_execution_model_not_ready"),
        (terminal_execution_patch_ready, "terminal_lifecycle_handoff_execution_patch_not_ready"),
        (terminal_execution_allowed, "terminal_lifecycle_handoff_execution_not_allowed"),
    ...
    gate_model: Dict[str, Any] = {
        "integrated_operation_readiness_preflight_gate_model_ready": True,
        "integrated_operation_readiness_preflight_model_ready": True,
        "integrated_operation_readiness_preflight_conditions_satisfied": conditions_satisfied,
        "integrated_operation_readiness_preflight_allowed": False,
        "integrated_operation_execution_allowed": False,
        "integrated_operation_blocked_reasons": blocked_reasons,
        "terminal_lifecycle_handoff_execution_report_required": True,
        "terminal_lifecycle_handoff_execution_report_ready": terminal_execution_report_ready,
        "terminal_lifecycle_handoff_execution_model_ready": terminal_execution_model_ready,
        "terminal_lifecycle_handoff_execution_patch_ready": terminal_execution_patch_ready,
        "terminal_lifecycle_handoff_execution_allowed": terminal_execution_allowed,
        ...
        "scheduler_start_allowed_after_integrated_readiness": False,
        "telegram_network_send_allowed_after_integrated_readiness": False,
        "paper_state_mutation_allowed_after_integrated_readiness": False,
        "paper_status_mutation_allowed_after_integrated_readiness": False,
    ...
    context = {
        "blocked_reason": "integrated_operation_readiness_preflight_blocked_until_complete_runtime_lifecycle_evidence_terminal_handoff_and_operator_gates",
        "terminal_lifecycle_handoff_execution_ready": terminal_execution_report_ready and terminal_execution_model_ready,
        "generic_terminal_lifecycle_handoff_execution_allowed": False,
        "generic_integrated_operation_readiness_preflight_ready": True,
    ...
    return {
        "mode": "generic_supervised_paper_integrated_operation_readiness_preflight_only",
        "preflight_only": True,
        "read_only": True,
        ...
        "paper_only": True,
        "preflight_source": "29.4.4u-49",
        "source_terminal_lifecycle_handoff_execution_map": source_map,
        ...
        "integrated_operation_readiness_preflight_context": context,
        "integrated_operation_readiness_preflight_gate_model": gate_model,
        "required_future_controls_before_integrated_operation_activation": {
            "terminal_lifecycle_handoff_execution_report_required": True,
        ...
        "stages": [
            ...
            for stage in INTEGRATED_OPERATION_READINESS_PREFLIGHT_STAGES
        ],
    }
...
def run_generic_supervised_paper_integrated_operation_readiness_preflight(
    settings: Settings | None = None,
) -> Dict[str, Any]:
    settings = settings or Settings()
    data_path = settings.data_path
    active_env = _active_lsr_env()
    upstream_path = data_path / "lsr_v2_generic_supervised_paper_terminal_lifecycle_handoff_execution_report.json"
    upstream = _read_json(upstream_path)
    upstream_present = bool(upstream)
    upstream_ready = upstream.get("decision") == U49_READY_DECISION and upstream.get(
        "generic_supervised_paper_terminal_lifecycle_handoff_execution_ready"
    ) is True
    ...
    readiness_map = _build_integrated_operation_readiness_preflight_map(upstream, active_env)
    gate = _as_dict(readiness_map.get("integrated_operation_readiness_preflight_gate_model", {}))
    ready = not blockers and bool(settings.fail_closed)

    diagnostic_count = _safe_int(upstream.get("terminal_lifecycle_handoff_execution_diagnostic_count"), 0)
    diagnostic_available = upstream.get("terminal_lifecycle_handoff_execution_diagnostic_available") is True
    ...
    report: Dict[str, Any] = {
        ...
        "classification_labels": [
            ...
            "INTEGRATED_OPERATION_READINESS_PREFLIGHT_ONLY",
            ...
            "NO_BROKER_CALL",
            "FAIL_CLOSED",
            "GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_PREFLIGHT_READY" if ready else "GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_READINESS_PREFLIGHT_NOT_READY",
        ],
        "blockers": blockers,
        "generic_supervised_paper_integrated_operation_readiness_preflight_ready": ready,
        "generic_integrated_operation_readiness_preflight_ready": ready,
        "generic_integrated_operation_readiness_preflight_model_ready": ready,
        "generic_integrated_operation_readiness_preflight_patch_ready": ready,
        "paper_integrated_operation_readiness_preflight_ready": ready,
        "integrated_operation_readiness_preflight_diagnostic_available": diagnostic_available if ready else False,
        "integrated_operation_readiness_preflight_diagnostic_count": diagnostic_count if ready else 0,
        "terminal_lifecycle_handoff_execution_diagnostic_available": diagnostic_available,
        "terminal_lifecycle_handoff_execution_diagnostic_count": diagnostic_count,
        "integrated_operation_readiness_preflight_contract_required_fields": contract_required,
        "integrated_operation_readiness_preflight_contract_present_fields": contract_present,
        "integrated_operation_readiness_preflight_contract_missing_fields": contract_missing,
        "integrated_operation_readiness_preflight_contract_shape_modelable": contract_shape_modelable,
        "generic_supervised_paper_integrated_operation_readiness_preflight_map": readiness_map,
        "blocked_until_runtime_integrated_operation_prerequisites": list(
            BLOCKED_UNTIL_RUNTIME_INTEGRATED_OPERATION_PREREQUISITES
        ),
        ...
        "u49_terminal_lifecycle_handoff_execution_report_present": upstream_present,
        "u49_terminal_lifecycle_handoff_execution_ready": upstream_ready,
        "generic_terminal_lifecycle_handoff_execution_ready": upstream.get("generic_terminal_lifecycle_handoff_execution_ready") is True,
        "generic_terminal_lifecycle_handoff_execution_model_ready": upstream.get("generic_terminal_lifecycle_handoff_execution_model_ready") is True,
        "generic_terminal_lifecycle_handoff_execution_patch_ready": upstream.get("generic_terminal_lifecycle_handoff_execution_patch_ready") is True,
        ...
        "paper_terminal_lifecycle_handoff_ready": upstream.get("paper_terminal_lifecycle_handoff_ready") is True,
        "paper_integrated_operation_ready": False,
        "terminal_lifecycle_handoff_runtime_executed": upstream.get("terminal_lifecycle_handoff_runtime_executed") is True,
        "scheduler_completion_handoff_runtime_executed": upstream.get("scheduler_completion_handoff_runtime_executed") is True,
        "telegram_lifecycle_completion_send_runtime_executed": upstream.get("telegram_lifecycle_completion_send_runtime_executed") is True,
        "paper_state_terminal_handoff_mutated": upstream.get("paper_state_terminal_handoff_mutated") is True,
        "paper_status_terminal_handoff_mutated": upstream.get("paper_status_terminal_handoff_mutated") is True,
        ...
        "lifecycle_state_status_completion_mutation_runtime_executed": upstream.get("lifecycle_state_status_completion_mutation_runtime_executed") is True,
        ...
        "generic_terminal_lifecycle_handoff_execution_allowed": False,
        "generic_integrated_operation_readiness_allowed": False,
        "generic_integrated_operation_readiness_preflight_allowed": False,
        "generic_integrated_operation_allowed": False,
        ...
        "would_run_postmortem": False,
        "would_run_lifecycle_completion_audit": False,
        "orders_submitted_by_generic_integrated_operation_readiness_preflight": 0,
        "orders_closed_by_generic_integrated_operation_readiness_preflight": 0,
        "positions_opened_by_generic_integrated_operation_readiness_preflight": 0,
        "positions_closed_by_generic_integrated_operation_readiness_preflight": 0,
        "paper_state_modified_by_generic_integrated_operation_readiness_preflight": False,
        "paper_status_modified_by_generic_integrated_operation_readiness_preflight": False,
        "telegram_sent_by_generic_integrated_operation_readiness_preflight": False,
        "scheduler_started_by_generic_integrated_operation_readiness_preflight": False,
        "broker_submit_allowed": False,
        "broker_close_allowed": False,
        "broker_submit_called_by_upstream_terminal_lifecycle_handoff_execution": upstream.get("broker_submit_called_by_generic_terminal_lifecycle_handoff_execution") is True,
        "broker_close_called_by_upstream_terminal_lifecycle_handoff_execution": upstream.get("broker_close_called_by_generic_terminal_lifecycle_handoff_execution") is True,
        "broker_submit_called_by_generic_integrated_operation_readiness_preflight": False,
        "broker_close_called_by_generic_integrated_operation_readiness_preflight": False,
        "live_enabled": False,
