"""Generic LSR-v2 supervised paper runtime arming bundle.

29.4.4u-66 is a macro-patch that groups three runtime-arming gate steps:

1. paper runtime arming preflight
2. paper runtime arming execution scaffold
3. paper runtime arming execution

The bundle consumes the u-65 runtime activation terminal audit bundle report. It
models readiness gates only. It does not arm the paper runtime, build or run a
...
The execution step removes only the explicit "future runtime arming execution
...
remain required before any future paper runtime arming can become real.
"""
...
PROMPT = "29.4.4u-66"
BUNDLE_EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_BUNDLE"

PREFLIGHT_EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_PREFLIGHT"
SCAFFOLD_EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_EXECUTION_SCAFFOLD"
EXECUTION_EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_EXECUTION"

PREFLIGHT_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_PREFLIGHT_READY"
SCAFFOLD_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_EXECUTION_SCAFFOLD_READY"
EXECUTION_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_EXECUTION_READY"
BUNDLE_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_BUNDLE_READY"

U65_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ACTIVATION_TERMINAL_AUDIT_BUNDLE_READY"
...
RUNTIME_ARMING_ENABLE_ENV = "LSR_V2_GENERIC_PAPER_RUNTIME_ARMING_ENABLE"
RUNTIME_ARMING_CONFIRMATION_ENV = "LSR_V2_GENERIC_PAPER_RUNTIME_ARMING_CONFIRMATION"
RUNTIME_ARMING_CONFIRMATION_SENTINEL = "I_UNDERSTAND_GENERIC_PAPER_RUNTIME_ARMING_ONLY"

REQUIRED_SOURCE_MARKERS: Tuple[Tuple[str, Tuple[str, ...]], ...] = (
    (
        "trading_bot/core/lsr_v2_generic_supervised_paper_runtime_activation_terminal_audit_bundle.py",
        (
            "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ACTIVATION_TERMINAL_AUDIT_BUNDLE",
            "generic_runtime_activation_terminal_audit_bundle_ready",
        ),
    ),
...
BUNDLE_SOURCE_MARKERS: Tuple[Tuple[str, Tuple[str, ...]], ...] = (
    (
        ...
        ("run_generic_supervised_paper_runtime_arming_preflight",),
    ),
    (
        "trading_bot/core/lsr_v2_generic_supervised_paper_runtime_arming_execution_scaffold.py",
        ("run_generic_supervised_paper_runtime_arming_execution_scaffold",),
    ),
    (
        "trading_bot/core/lsr_v2_generic_supervised_paper_runtime_arming_execution.py",
        ("run_generic_supervised_paper_runtime_arming_execution",),
    ),
)

BLOCKED_UNTIL_RUNTIME_ARMING_PREREQUISITES: Tuple[str, ...] = (
...
RUNTIME_ABSENT_REASONS: Tuple[str, ...] = (
    ...
    "operator_paper_runtime_arming_gate_not_satisfied",
...
def _dry_run_order_intent_payload(source: Mapping[str, Any] | None = None) -> Dict[str, Any]:
    ...
    if isinstance(source, Mapping):
        for key in (
            "generic_supervised_paper_runtime_activation_terminal_audit_bundle_map",
    ...
    payload.update(
        {
            ...
            "broker_submit_called_by_generic_paper_runtime_arming_bundle": False,
            "broker_close_called_by_generic_paper_runtime_arming_bundle": False,
            "positions_opened_by_generic_paper_runtime_arming_bundle": 0,
            "positions_closed_by_generic_paper_runtime_arming_bundle": 0,
            "orders_submitted_by_generic_paper_runtime_arming_bundle": 0,
            "orders_closed_by_generic_paper_runtime_arming_bundle": 0,
            "paper_state_modified_by_generic_paper_runtime_arming_bundle": False,
            "paper_status_modified_by_generic_paper_runtime_arming_bundle": False,
            "scheduler_started_by_generic_paper_runtime_arming_bundle": False,
            "telegram_network_send_called_by_generic_paper_runtime_arming_bundle": False,
...
def _phase_specs() -> Dict[str, Dict[str, str]]:
    return {
        "preflight": {
            ...
            "upstream_report": "lsr_v2_generic_supervised_paper_runtime_activation_terminal_audit_bundle_report.json",
            "upstream_decision": U65_READY_DECISION,
            "upstream_ready_key": "generic_supervised_paper_runtime_activation_terminal_audit_bundle_ready",
            "report_name": "lsr_v2_generic_supervised_paper_runtime_arming_preflight_report.json",
            "jsonl_name": "lsr_v2_generic_supervised_paper_runtime_arming_preflight.jsonl",
            "mode": "generic_supervised_paper_runtime_arming_preflight_only",
            "classification": "PAPER_RUNTIME_ARMING_PREFLIGHT_ONLY",
            "ready_key": "generic_supervised_paper_runtime_arming_preflight_ready",
            "phase_allowed_key": "generic_paper_runtime_arming_preflight_allowed",
            "phase_model_ready_key": "generic_paper_runtime_arming_preflight_model_ready",
            "phase_patch_ready_key": "generic_paper_runtime_arming_preflight_patch_ready",
            "phase_ready_key": "generic_paper_runtime_arming_preflight_ready",
            "paper_ready_key": "paper_runtime_arming_preflight_ready",
            "map_key": "generic_supervised_paper_runtime_arming_preflight_map",
            "gate_key": "paper_runtime_arming_preflight_gate_model",
            "context_key": "paper_runtime_arming_preflight_context",
            "blocked_reasons_key": "paper_runtime_arming_preflight_blocked_reasons",
            "conditions_key": "paper_runtime_arming_preflight_conditions_satisfied",
            "source_map_key": "source_runtime_activation_terminal_audit_bundle_map",
            "blocked_reason": "paper_runtime_arming_preflight_blocked_until_complete_runtime_lifecycle_evidence_operator_gates_and_explicit_runtime_arming_execution_patch",
        },
        "execution_scaffold": {
            "event_type": SCAFFOLD_EVENT_TYPE,
            "ready_decision": SCAFFOLD_READY_DECISION,
            "upstream_report": "lsr_v2_generic_supervised_paper_runtime_arming_preflight_report.json",
            "upstream_decision": PREFLIGHT_READY_DECISION,
            "upstream_ready_key": "generic_supervised_paper_runtime_arming_preflight_ready",
            "report_name": "lsr_v2_generic_supervised_paper_runtime_arming_execution_scaffold_report.json",
            "jsonl_name": "lsr_v2_generic_supervised_paper_runtime_arming_execution_scaffold.jsonl",
            "mode": "generic_supervised_paper_runtime_arming_execution_scaffold_only",
            "classification": "PAPER_RUNTIME_ARMING_EXECUTION_SCAFFOLD_ONLY",
            "ready_key": "generic_supervised_paper_runtime_arming_execution_scaffold_ready",
            "phase_allowed_key": "generic_paper_runtime_arming_execution_scaffold_allowed",
            "phase_model_ready_key": "generic_paper_runtime_arming_execution_scaffold_model_ready",
            "phase_patch_ready_key": "generic_paper_runtime_arming_execution_scaffold_patch_ready",
            "phase_ready_key": "generic_paper_runtime_arming_execution_scaffold_ready",
            "paper_ready_key": "paper_runtime_arming_execution_scaffold_ready",
            "map_key": "generic_supervised_paper_runtime_arming_execution_scaffold_map",
            "gate_key": "paper_runtime_arming_execution_scaffold_gate_model",
            "context_key": "paper_runtime_arming_execution_scaffold_context",
            "blocked_reasons_key": "paper_runtime_arming_execution_scaffold_blocked_reasons",
            "conditions_key": "paper_runtime_arming_execution_scaffold_conditions_satisfied",
            "source_map_key": "source_paper_runtime_arming_preflight_map",
            "blocked_reason": "paper_runtime_arming_execution_scaffold_blocked_until_complete_runtime_lifecycle_evidence_operator_gates_and_explicit_runtime_arming_execution_patch",
        },
        "execution": {
            "event_type": EXECUTION_EVENT_TYPE,
            "ready_decision": EXECUTION_READY_DECISION,
            "upstream_report": "lsr_v2_generic_supervised_paper_runtime_arming_execution_scaffold_report.json",
            "upstream_decision": SCAFFOLD_READY_DECISION,
            "upstream_ready_key": "generic_supervised_paper_runtime_arming_execution_scaffold_ready",
            "report_name": "lsr_v2_generic_supervised_paper_runtime_arming_execution_report.json",
            "jsonl_name": "lsr_v2_generic_supervised_paper_runtime_arming_execution.jsonl",
            "mode": "generic_supervised_paper_runtime_arming_execution_controlled",
            "classification": "PAPER_RUNTIME_ARMING_EXECUTION_CONTROLLED",
            "ready_key": "generic_supervised_paper_runtime_arming_execution_ready",
            "phase_allowed_key": "generic_paper_runtime_arming_execution_allowed",
            "phase_model_ready_key": "generic_paper_runtime_arming_execution_model_ready",
            "phase_patch_ready_key": "generic_paper_runtime_arming_execution_patch_ready",
            "phase_ready_key": "generic_paper_runtime_arming_execution_ready",
            "paper_ready_key": "paper_runtime_arming_execution_ready",
            "map_key": "generic_supervised_paper_runtime_arming_execution_map",
            "gate_key": "paper_runtime_arming_execution_gate_model",
            "context_key": "paper_runtime_arming_execution_context",
            "blocked_reasons_key": "paper_runtime_arming_execution_blocked_reasons",
            "conditions_key": "paper_runtime_arming_execution_conditions_satisfied",
            "source_map_key": "source_paper_runtime_arming_execution_scaffold_map",
            "blocked_reason": "paper_runtime_arming_execution_blocked_until_complete_runtime_lifecycle_evidence_operator_gates_and_runtime_still_blocked",
        },
    }
...
def _build_phase_report(settings: Settings, phase: str, *, write_artifacts: bool = True) -> Dict[str, Any]:
    ...
    explicit_patch_reason = "explicit_paper_runtime_arming_execution_patch_required"
    ...
    operator_gate_satisfied = _operator_gate_satisfied(
        RUNTIME_ARMING_ENABLE_ENV,
        RUNTIME_ARMING_CONFIRMATION_ENV,
        RUNTIME_ARMING_CONFIRMATION_SENTINEL,
    )

    context = {
        "blocked_reason": specs["blocked_reason"],
        "generic_paper_runtime_arming_preflight_allowed": False,
        "generic_paper_runtime_arming_execution_scaffold_allowed": False,
    ...
    gate = {
        "paper_runtime_arming_required": True,
        "paper_runtime_arming_runtime_executed": False,
        ...
        "runtime_values_present": False,
        "runtime_values_required_before_paper_runtime_arming": True,
        "paper_only": True,
        "paper_only_valid": True,
        "max_open_positions": 1,
        "max_open_positions_valid": True,
        "live_testnet_exchange_required_off": True,
        "operator_paper_runtime_arming_enable_env": RUNTIME_ARMING_ENABLE_ENV,
        "operator_paper_runtime_arming_confirmation_env": RUNTIME_ARMING_CONFIRMATION_ENV,
        "operator_paper_runtime_arming_confirmation_required_value": RUNTIME_ARMING_CONFIRMATION_SENTINEL,
        "operator_paper_runtime_arming_gate_required": True,
        "operator_paper_runtime_arming_gate_satisfied": operator_gate_satisfied,
        ...
        "paper_runtime_arming_allowed": False,
        "paper_runtime_arming_execution_allowed": False,
        ...
        "scheduler_start_allowed_after_paper_runtime_arming": False,
        "telegram_network_send_allowed_after_paper_runtime_arming": False,
        "paper_state_mutation_allowed_after_paper_runtime_arming": False,
        "paper_status_mutation_allowed_after_paper_runtime_arming": False,
    }

    phase_map = {
        "mode": specs["mode"],
        "preflight_source": "29.4.4u-65" if phase == "preflight" else PROMPT,
        "read_only": True,
        ...
        "required_future_controls_before_paper_runtime_arming_execution": {
            "runtime_activation_terminal_audit_bundle_report_required": True,
            "paper_runtime_arming_runtime_required_before_integrated_operation": True,
            "runtime_activation_terminal_audit_runtime_required_before_paper_runtime_arming": True,
            "runtime_activation_envelope_runtime_required_before_paper_runtime_arming": True,
            "terminal_ready_synthesis_runtime_required_before_paper_runtime_arming": True,
            "final_readiness_audit_handoff_runtime_required_before_paper_runtime_arming": True,
            "terminal_lifecycle_handoff_runtime_required_before_paper_runtime_arming": True,
            "scheduler_completion_handoff_runtime_required_before_paper_runtime_arming": True,
            "telegram_lifecycle_completion_send_runtime_required_before_paper_runtime_arming": True,
            "paper_state_terminal_handoff_required_before_paper_runtime_arming": True,
            "paper_status_terminal_handoff_required_before_paper_runtime_arming": True,
            "broker_submit_receipt_required_before_paper_runtime_arming": True,
            "broker_close_receipt_required_before_paper_runtime_arming": True,
            "real_close_execution_required_before_paper_runtime_arming": True,
            "closed_position_required_before_paper_runtime_arming": True,
            "realized_pnl_written_required_before_paper_runtime_arming": True,
            "runtime_value_validation_required": True,
            "runtime_values_required": True,
            "paper_only_required": True,
            "max_open_positions": 1,
            "live_testnet_exchange_required_off": True,
            "generic_paper_runtime_arming_operator_gate_required": True,
        ...
        "stages": [
            ...
            {"stage": "verify_no_paper_runtime_arming_runtime", "execution_allowed": False, "state_mutation_allowed": False},
            ...
            {"stage": "map_paper_runtime_arming_gate", "execution_allowed": False, "state_mutation_allowed": False},
            {"stage": "publish_paper_runtime_arming_artifact", "execution_allowed": False, "state_mutation_allowed": False},
        ],
    }
    ...
    report.update(
        {
            ...
            "blocked_until_paper_runtime_arming_prerequisites": list(BLOCKED_UNTIL_RUNTIME_ARMING_PREREQUISITES),
            ...
            "paper_runtime_arming_diagnostic_available": ready,
            "paper_runtime_arming_diagnostic_count": 411 if phase == "preflight" else 412 if phase == "execution_scaffold" else 413,
...
def run_generic_supervised_paper_runtime_arming_preflight(
    settings: Settings | None = None,
) -> Dict[str, Any]:
    return _build_phase_report(settings or Settings(), "preflight")


def run_generic_supervised_paper_runtime_arming_execution_scaffold(
    settings: Settings | None = None,
) -> Dict[str, Any]:
    return _build_phase_report(settings or Settings(), "execution_scaffold")


def run_generic_supervised_paper_runtime_arming_execution(
    settings: Settings | None = None,
) -> Dict[str, Any]:
    return _build_phase_report(settings or Settings(), "execution")


def run_generic_supervised_paper_runtime_arming_bundle(
    settings: Settings | None = None,
) -> Dict[str, Any]:
    settings = settings or Settings()
    preflight = run_generic_supervised_paper_runtime_arming_preflight(settings)
    scaffold = run_generic_supervised_paper_runtime_arming_execution_scaffold(settings)
    execution = run_generic_supervised_paper_runtime_arming_execution(settings)
    ready = (
    ...
    bundle.update(
        {
            ...
            "generated_at": _now(),
            "status": "PASS" if ready else "FAIL",
            "decision": BUNDLE_READY_DECISION if ready else "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_BUNDLE_NOT_READY",
            "generic_supervised_paper_runtime_arming_bundle_ready": ready,
            "generic_paper_runtime_arming_bundle_ready": ready,
            ...
            "classification_labels": [
                ...
                "NO_BROKER_CALL",
                "FAIL_CLOSED",
                "GENERIC_SUPERVISED_PAPER_RUNTIME_ARMING_BUNDLE_READY",
            ],
            "bundle_steps": {
                "preflight": {
                    "status": preflight.get("status"),
                    "decision": preflight.get("decision"),
                    "ready": preflight.get("generic_supervised_paper_runtime_arming_preflight_ready"),
                    "report": preflight.get("report"),
                },
                "execution_scaffold": {
                    "status": scaffold.get("status"),
                    "decision": scaffold.get("decision"),
                    "ready": scaffold.get("generic_supervised_paper_runtime_arming_execution_scaffold_ready"),
                    "report": scaffold.get("report"),
                },
                "execution": {
                    "status": execution.get("status"),
                    "decision": execution.get("decision"),
                    "ready": execution.get("generic_supervised_paper_runtime_arming_execution_ready"),
                    "report": execution.get("report"),
                },
            },
            "blocked_until_paper_runtime_arming_prerequisites": list(BLOCKED_UNTIL_RUNTIME_ARMING_PREREQUISITES),
            "blockers": [] if ready else ["bundle_substep_not_ready"],
            "report": str(settings.data_path / "lsr_v2_generic_supervised_paper_runtime_arming_bundle_report.json"),
            "jsonl": str(settings.data_path / "lsr_v2_generic_supervised_paper_runtime_arming_bundle.jsonl"),
        }
    )
    _write_json(settings.data_path / "lsr_v2_generic_supervised_paper_runtime_arming_bundle_report.json", bundle)
    _append_jsonl(settings.data_path / "lsr_v2_generic_supervised_paper_runtime_arming_bundle.jsonl", bundle)
    return bundle
