"""Generic LSR-v2 supervised paper postmortem preflight.

29.4.4u-38 is a paper-only postmortem preflight. It consumes u-37's
controlled final-audit execution artifact and models the full prerequisite set
that a later real postmortem execution patch would require after a complete
...
final audit execution, no runtime values, and no operator gates. Therefore this
patch must return a PASS/ready diagnostic for the postmortem preflight model
while keeping postmortem execution, broker calls, state mutation,
Telegram/network sending, scheduler startup, and live/testnet/exchange access
blocked.
"""
...
PROMPT = "29.4.4u-38"
EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_POSTMORTEM_PREFLIGHT"
READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_POSTMORTEM_PREFLIGHT_READY"
KEEP_DIAGNOSTIC_DECISION = "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_SUPERVISED_PAPER_POSTMORTEM_PREFLIGHT_NOT_READY"
U37_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_FINAL_AUDIT_EXECUTION_READY"
...
POSTMORTEM_PREFLIGHT_STAGES: Tuple[str, ...] = (
    "load_generic_final_audit_execution",
    "verify_final_audit_execution_report_ready",
    "verify_final_audit_execution_was_blocked",
    "verify_no_broker_close_receipt",
    "verify_no_real_final_audit_runtime_execution",
    "verify_no_postmortem_available",
    "verify_no_realized_pnl_written",
    "verify_postmortem_requires_final_audit_close_receipt_and_realized_pnl",
    ...
    "map_postmortem_preflight_gate",
    "publish_generic_postmortem_preflight_artifact",
)

BLOCKED_UNTIL_POSTMORTEM_EXECUTION_PATCH: Tuple[str, ...] = (
...
REQUIRED_SOURCE_MARKERS: Tuple[Tuple[str, Tuple[str, ...]], ...] = (
    (
        ...
        (
            ...
            "generic_supervised_paper_final_audit_execution_ready",
        ),
    ),
...
class Settings:
    ...
    data_dir: str = "data"
    report_name: str = "lsr_v2_generic_supervised_paper_postmortem_preflight_report.json"
    jsonl_name: str = "lsr_v2_generic_supervised_paper_postmortem_preflight.jsonl"
...
def _dry_run_payload(final_audit_report: Mapping[str, Any]) -> Dict[str, Any]:
    final_map = _as_dict(final_audit_report.get("generic_supervised_paper_final_audit_execution_map", {}))
    payload = _as_dict(final_map.get("dry_run_order_intent_payload", {}))
    if payload:
        return payload
    scaffold_map = _as_dict(final_audit_report.get("generic_supervised_paper_final_audit_execution_scaffold_map", {}))
...
def _build_postmortem_preflight_map(final_audit_report: Mapping[str, Any], active_env: Mapping[str, str]) -> Dict[str, Any]:
    source_map = _as_dict(final_audit_report.get("generic_supervised_paper_final_audit_execution_map", {}))
    source_gate = _as_dict(source_map.get("final_audit_execution_gate_model", {}))
    payload = _dry_run_payload(final_audit_report)
    ...
    final_audit_execution_report_ready = final_audit_report.get("generic_supervised_paper_final_audit_execution_ready") is True
    final_audit_execution_model_ready = final_audit_report.get("generic_final_audit_execution_model_ready") is True
    final_audit_execution_gate_model_ready = final_audit_report.get("generic_final_audit_execution_gate_model_ready") is True
    final_audit_execution_allowed = final_audit_report.get("generic_final_audit_execution_allowed") is True
    paper_final_audit_ready = final_audit_report.get("paper_final_audit_ready") is True
    final_audit_runtime_executed = final_audit_report.get("would_run_final_audit") is True and final_audit_execution_allowed
    broker_submit_receipt_available = final_audit_report.get("broker_submit_receipt_available") is True
    broker_close_receipt_available = final_audit_report.get("broker_close_receipt_available") is True
    real_close_execution_available = final_audit_report.get("real_close_execution_available") is True
    paper_position_closed = final_audit_report.get("paper_position_closed") is True
    paper_realized_pnl_reconciliation_ready = final_audit_report.get("paper_realized_pnl_reconciliation_ready") is True
    realized_pnl_written = final_audit_report.get("realized_pnl_written") is True or final_audit_report.get("would_write_realized_pnl") is True

    postmortem_conditions_satisfied = all(
        [
            final_audit_execution_report_ready,
            final_audit_execution_model_ready,
            final_audit_execution_gate_model_ready,
            final_audit_execution_allowed,
    ...
    if not final_audit_execution_report_ready:
        blocked_reasons.append("final_audit_execution_report_not_ready")
    if not final_audit_execution_model_ready:
        blocked_reasons.append("final_audit_execution_model_not_ready")
    if not final_audit_execution_gate_model_ready:
        blocked_reasons.append("final_audit_execution_gate_model_not_ready")
    if not final_audit_execution_allowed:
        blocked_reasons.append("final_audit_execution_not_allowed")
    ...
    gate_model = {
        ...
        "postmortem_conditions_satisfied": postmortem_conditions_satisfied,
        "postmortem_execution_allowed": False,
        "postmortem_preflight_blocked_reasons": blocked_reasons,
        "final_audit_execution_report_required": True,
        "final_audit_execution_report_ready": final_audit_execution_report_ready,
        "final_audit_execution_model_ready": final_audit_execution_model_ready,
        "final_audit_execution_gate_model_ready": final_audit_execution_gate_model_ready,
        "final_audit_execution_required_before_postmortem": True,
        "final_audit_execution_allowed": final_audit_execution_allowed,
        ...
        "runtime_values_required_before_postmortem": True,
    ...
    context = {
        "blocked_reason": "postmortem_preflight_blocked_until_real_final_audit_realized_pnl_close_receipt_and_gates",
        ...
        "final_audit_execution_report_ready": final_audit_execution_report_ready,
        "generic_final_audit_execution_allowed": final_audit_execution_allowed,
        "paper_final_audit_ready": paper_final_audit_ready,
        "final_audit_runtime_executed": final_audit_runtime_executed,
        "broker_submit_receipt_available": broker_submit_receipt_available,
        "broker_close_receipt_available": broker_close_receipt_available,
    ...
    return {
        "mode": "generic_supervised_paper_postmortem_preflight_only",
        "preflight_source": "29.4.4u-37",
        "postmortem_preflight_patch": True,
        "preflight_only": True,
        "read_only": True,
        ...
        "postmortem_preflight_gate_model": gate_model,
        "postmortem_preflight_context": context,
        "source_final_audit_execution_map": source_map,
        "required_future_controls_before_postmortem_execution": {
            "explicit_generic_postmortem_execution_scaffold_patch_required": True,
        ...
        "stages": [
            ...
            for stage in POSTMORTEM_PREFLIGHT_STAGES
        ],
    }


def run_generic_supervised_paper_postmortem_preflight(settings: Settings | None = None) -> Dict[str, Any]:
    settings = settings or Settings()
    data_path = settings.data_path
    upstream_name = "lsr_v2_generic_supervised_paper_final_audit_execution_report.json"
    final_audit_report = _read_json(data_path / upstream_name)
    ...
    missing_upstream_reports = [] if final_audit_report else [upstream_name]
    upstream_ready = (
        final_audit_report.get("decision") == U37_READY_DECISION
        and final_audit_report.get("generic_supervised_paper_final_audit_execution_ready") is True
    )
    not_ready_upstream_reports = [] if not final_audit_report or upstream_ready else [upstream_name]

    postmortem_map = _build_postmortem_preflight_map(final_audit_report, active_env)
    gate_model = _as_dict(postmortem_map.get("postmortem_preflight_gate_model", {}))
    context = _as_dict(postmortem_map.get("postmortem_preflight_context", {}))
    payload = _as_dict(postmortem_map.get("dry_run_order_intent_payload", {}))
    present_fields_ok = _as_list(postmortem_map.get("present_contract_fields", [])) == list(REQUIRED_ORDER_INTENT_FIELDS)
    required_fields_ok = _as_list(postmortem_map.get("required_contract_fields", [])) == list(REQUIRED_ORDER_INTENT_FIELDS)
    missing_fields_ok = _as_list(postmortem_map.get("missing_contract_fields", [])) == []

    diagnostic_count = _safe_int(final_audit_report.get("final_audit_execution_diagnostic_count"), 0)
    source_counts = _as_dict(final_audit_report.get("candidate_detection_source_counts", {}))
    if not diagnostic_count:
        diagnostic_count = sum(_safe_int(v) for v in source_counts.values())
    diagnostic_available = final_audit_report.get("final_audit_execution_diagnostic_available") is True or diagnostic_count > 0

    required_readiness = {
        "u37_final_audit_execution_report_present": bool(final_audit_report),
        "u37_final_audit_execution_ready": upstream_ready,
        "source_markers_present": source_markers_present,
        "postmortem_preflight_model_ready": gate_model.get("postmortem_preflight_model_ready") is True,
        "postmortem_gate_model_ready": gate_model.get("postmortem_gate_model_ready") is True,
        ...
        "execution_disabled": postmortem_map.get("execution_enabled") is False,
        "mutation_disabled": postmortem_map.get("mutation_enabled") is False,
        "broker_disabled": postmortem_map.get("broker_submit_enabled") is False and postmortem_map.get("broker_close_enabled") is False,
        "scheduler_disabled": postmortem_map.get("scheduler_enabled") is False,
        "telegram_network_disabled": postmortem_map.get("telegram_network_send_enabled") is False,
        "live_testnet_exchange_disabled": True,
        "execution_flags_fail_closed": _all_false(final_audit_report, FALSE_EXECUTION_KEYS),
        "postmortem_currently_blocked": gate_model.get("postmortem_conditions_satisfied") is False,
    ...
    classification_labels = [
        ...
        "POSTMORTEM_PREFLIGHT_ONLY",
        "READ_ONLY_BY_DEFAULT",
        "NO_ORDINAL_EXPANSION",
        "NO_POSTMORTEM_EXECUTION",
        ...
        "NO_SCHEDULER",
        "FAIL_CLOSED",
        "GENERIC_SUPERVISED_PAPER_POSTMORTEM_PREFLIGHT_READY" if ready else "GENERIC_SUPERVISED_PAPER_POSTMORTEM_PREFLIGHT_NOT_READY",
    ]
    ...
    report: Dict[str, Any] = {
        ...
        "upstream_reports_present": [] if not final_audit_report else [upstream_name],
        "missing_upstream_reports": missing_upstream_reports,
        "not_ready_upstream_reports": not_ready_upstream_reports,
        "generic_supervised_paper_postmortem_preflight_ready": ready,
        "generic_postmortem_preflight_ready": ready,
        "generic_postmortem_preflight_model_ready": gate_model.get("postmortem_preflight_model_ready") is True,
        "generic_postmortem_preflight_patch_ready": ready,
        "paper_postmortem_preflight_ready": ready,
        "postmortem_preflight_diagnostic_available": ready and diagnostic_available,
        "postmortem_preflight_diagnostic_count": diagnostic_count if ready else 0,
        "postmortem_preflight_contract_shape_modelable": gate_model.get("postmortem_preflight_model_ready") is True,
        "postmortem_preflight_contract_missing_fields": _as_list(postmortem_map.get("missing_contract_fields", [])),
        "postmortem_preflight_contract_present_fields": _as_list(postmortem_map.get("present_contract_fields", [])),
        "postmortem_preflight_contract_required_fields": _as_list(postmortem_map.get("required_contract_fields", [])),
        "generic_supervised_paper_final_audit_execution_ready": final_audit_report.get("generic_supervised_paper_final_audit_execution_ready") is True,
        "generic_final_audit_execution_model_ready": final_audit_report.get("generic_final_audit_execution_model_ready") is True,
        "generic_final_audit_execution_patch_ready": final_audit_report.get("generic_final_audit_execution_patch_ready") is True,
        "generic_final_audit_execution_gate_model_ready": final_audit_report.get("generic_final_audit_execution_gate_model_ready") is True,
        "paper_final_audit_execution_model_ready": final_audit_report.get("paper_final_audit_execution_model_ready") is True,
        "final_audit_execution_diagnostic_available": diagnostic_available,
        "final_audit_execution_diagnostic_count": diagnostic_count,
        "candidate_detection_source_counts": source_counts,
        "candidate_diagnostic_examples": _candidate_examples(final_audit_report),
        "broker_submit_receipt_available": final_audit_report.get("broker_submit_receipt_available") is True,
        "broker_close_receipt_available": final_audit_report.get("broker_close_receipt_available") is True,
        "real_close_execution_available": final_audit_report.get("real_close_execution_available") is True,
        "paper_position_closed": final_audit_report.get("paper_position_closed") is True,
        "realized_pnl_written": final_audit_report.get("realized_pnl_written") is True or final_audit_report.get("would_write_realized_pnl") is True,
        "paper_final_audit_ready": final_audit_report.get("paper_final_audit_ready") is True,
        "final_audit_runtime_executed": context.get("final_audit_runtime_executed") is True,
        ...
        "paper_order_intent_runtime_values_required_before_postmortem": True,
        ...
        "generic_supervised_paper_postmortem_preflight_map": postmortem_map,
        "generic_supervised_paper_final_audit_execution_map": _as_dict(final_audit_report.get("generic_supervised_paper_final_audit_execution_map", {})),
        "generic_supervised_paper_final_audit_execution_scaffold_map": _as_dict(final_audit_report.get("generic_supervised_paper_final_audit_execution_scaffold_map", {})),
        "generic_supervised_paper_final_audit_preflight_map": _as_dict(final_audit_report.get("generic_supervised_paper_final_audit_preflight_map", {})),
        "generic_supervised_paper_realized_pnl_reconciliation_preflight_map": _as_dict(final_audit_report.get("generic_supervised_paper_realized_pnl_reconciliation_preflight_map", {})),
        "generic_supervised_paper_close_execution_map": _as_dict(final_audit_report.get("generic_supervised_paper_close_execution_map", {})),
        "blocked_until_postmortem_execution_patch": list(BLOCKED_UNTIL_POSTMORTEM_EXECUTION_PATCH),
        ...
        "lifecycle_state": final_audit_report.get("lifecycle_state", ""),
        "fourth_trade_locked": final_audit_report.get("fourth_trade_locked") is True,
        "stability_lock_active": final_audit_report.get("stability_lock_active") is True,
        ...
        "paper_state_status_consistency": final_audit_report.get("paper_state_status_consistency") is True,
        "source_markers_present": source_markers_present,
        ...
        "paper_state_modified_by_generic_postmortem_preflight": False,
        "paper_status_modified_by_generic_postmortem_preflight": False,
        "orders_submitted_by_generic_postmortem_preflight": 0,
        "positions_opened_by_generic_postmortem_preflight": 0,
        "positions_closed_by_generic_postmortem_preflight": 0,
        "broker_submit_called_by_generic_postmortem_preflight": False,
        "broker_close_called_by_generic_postmortem_preflight": False,
        "telegram_network_called_by_generic_postmortem_preflight": False,
        "scheduler_started_by_generic_postmortem_preflight": False,
    }
...
def main() -> None:
    report = run_generic_supervised_paper_postmortem_preflight()
