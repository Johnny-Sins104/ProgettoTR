"""Generic LSR-v2 supervised paper integrated operation final readiness audit execution.

29.4.4u-55 consumes u-54's integrated operation final readiness audit execution
scaffold artifact and turns it into the controlled execution gate for the final
readiness audit model. This patch removes the explicit “future final readiness
audit execution patch required” blocker because this is that execution patch.

It still remains read-only by default and fail-closed. In the expected validation
state it must not run the final readiness audit, run integrated operation, hand
off terminal lifecycle, mutate paper_state or paper_status, send Telegram or
...
PROMPT = "29.4.4u-55"
EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_EXECUTION"
READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_EXECUTION_READY"
KEEP_DIAGNOSTIC_DECISION = "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_EXECUTION_NOT_READY"
U54_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_EXECUTION_SCAFFOLD_READY"
...
FINAL_READINESS_AUDIT_EXECUTION_STAGES: Tuple[str, ...] = (
    "load_generic_integrated_operation_final_readiness_audit_execution_scaffold_report",
    "verify_integrated_operation_final_readiness_audit_execution_scaffold_model_ready",
    "verify_integrated_operation_final_readiness_audit_execution_scaffold_was_blocked",
    ...
    "verify_final_readiness_audit_execution_patch_current_step_but_runtime_still_blocked",
    ...
    "map_integrated_operation_final_readiness_audit_execution_gate",
    "publish_generic_integrated_operation_final_readiness_audit_execution_artifact",
)
...
REQUIRED_SOURCE_MARKERS: Tuple[Tuple[str, Tuple[str, ...]], ...] = (
    (
        ...
        (
            "GENERIC_LSR_V2_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_EXECUTION_SCAFFOLD",
            "generic_integrated_operation_final_readiness_audit_execution_scaffold_ready",
        ),
    ),
...
FALSE_EXECUTION_KEYS: Tuple[str, ...] = (
    ...
    "generic_integrated_operation_final_readiness_audit_execution_scaffold_allowed",
...
class Settings:
    ...
    data_dir: str = "data"
    report_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_final_readiness_audit_execution_report.json"
    jsonl_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_final_readiness_audit_execution.jsonl"
...
def _build_final_readiness_audit_execution_map(
    upstream: Mapping[str, Any], active_env: Mapping[str, str]
) -> Dict[str, Any]:
    source_map = _as_dict(upstream.get("generic_supervised_paper_integrated_operation_final_readiness_audit_execution_scaffold_map"))
    source_gate = _as_dict(source_map.get("integrated_operation_final_readiness_audit_execution_scaffold_gate_model"))
    dry_run_order_intent_payload = _as_dict(source_map.get("dry_run_order_intent_payload")) or _default_order_intent_payload()

    u54_report_ready = upstream.get("decision") == U54_READY_DECISION
    u54_ready = _bool_from_upstream(upstream, "generic_supervised_paper_integrated_operation_final_readiness_audit_execution_scaffold_ready")
    u54_model_ready = _bool_from_upstream(upstream, "generic_integrated_operation_final_readiness_audit_execution_scaffold_model_ready")
    u54_patch_ready = _bool_from_upstream(upstream, "generic_integrated_operation_final_readiness_audit_execution_scaffold_patch_ready")
    u54_allowed = _bool_from_upstream(upstream, "generic_integrated_operation_final_readiness_audit_execution_scaffold_allowed")
    ...
    gate_checks: Tuple[Tuple[bool, str], ...] = (
        (u54_report_ready, "integrated_operation_final_readiness_audit_execution_scaffold_report_not_ready"),
        (u54_ready, "integrated_operation_final_readiness_audit_execution_scaffold_not_ready"),
        (u54_model_ready, "integrated_operation_final_readiness_audit_execution_scaffold_model_not_ready"),
        (u54_patch_ready, "integrated_operation_final_readiness_audit_execution_scaffold_patch_not_ready"),
        (u54_allowed, "integrated_operation_final_readiness_audit_execution_scaffold_not_allowed"),
    ...
    gate_model = {
        ...
        "integrated_operation_readiness_execution_report_ready": u54_report_ready,
        "integrated_operation_readiness_execution_ready": u54_ready,
        "integrated_operation_readiness_execution_model_ready": u54_model_ready,
        "integrated_operation_readiness_execution_patch_ready": u54_patch_ready,
        "integrated_operation_readiness_execution_allowed": u54_allowed,
        "integrated_operation_final_readiness_audit_execution_gate_model_ready": True,
        "integrated_operation_final_readiness_audit_execution_model_ready": True,
        "integrated_operation_final_readiness_audit_execution_patch_ready": True,
        "integrated_operation_final_readiness_audit_execution_conditions_satisfied": preflight_conditions_satisfied,
        ...
        "integrated_operation_final_readiness_audit_execution_blocked_reasons": blocked_reasons,
        ...
        "scheduler_start_allowed_after_integrated_operation_final_readiness_audit_execution": False,
        "telegram_network_send_allowed_after_integrated_operation_final_readiness_audit_execution": False,
        "paper_state_mutation_allowed_after_integrated_operation_final_readiness_audit_execution": False,
        "paper_status_mutation_allowed_after_integrated_operation_final_readiness_audit_execution": False,
    ...
    context = {
        "blocked_reason": "integrated_operation_final_readiness_audit_execution_blocked_until_complete_runtime_lifecycle_evidence_operator_gates_and_runtime_still_blocked",
        "integrated_operation_final_readiness_audit_execution_scaffold_ready": u54_report_ready and u54_ready and u54_model_ready,
        "generic_integrated_operation_final_readiness_audit_execution_scaffold_allowed": u54_allowed,
        "generic_integrated_operation_final_readiness_audit_execution_ready": True,
    ...
    return {
        "mode": "generic_supervised_paper_integrated_operation_final_readiness_audit_execution_controlled",
        "read_only": True,
        ...
        "paper_only": True,
        "preflight_source": "29.4.4u-54",
        "source_integrated_operation_final_readiness_audit_execution_scaffold_map": source_map,
        ...
        "integrated_operation_final_readiness_audit_execution_context": context,
        "integrated_operation_final_readiness_audit_execution_gate_model": gate_model,
        ...
        "stages": [
            ...
            for stage in FINAL_READINESS_AUDIT_EXECUTION_STAGES
        ],
    }
...
def _build_report(settings: Settings, upstream: Mapping[str, Any] | None, markers_ok: bool, missing_files: List[str], missing_markers: Dict[str, List[str]]) -> Dict[str, Any]:
    ...
    if upstream is None:
        ...
        upstream = {}
    elif upstream.get("decision") != U54_READY_DECISION:
        blockers.append("not_ready_upstream_reports")
    if not markers_ok:
        blockers.append("missing_source_markers")

    final_map = _build_final_readiness_audit_execution_map(upstream, active_env)
    status = "PASS" if not blockers else "FAIL"
    decision = READY_DECISION if status == "PASS" else KEEP_DIAGNOSTIC_DECISION
    diagnostic_count = _safe_int(upstream.get("integrated_operation_final_readiness_audit_execution_scaffold_diagnostic_count", upstream.get("candidate_detection_source_counts", {}).get("paper_events_jsonl_diagnostic_read", 0))) + 1
    ...
    report: Dict[str, Any] = {
        ...
        "classification_labels": [
            ...
            "INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_EXECUTION_CONTROLLED",
            ...
            "NO_BROKER_CALL",
            "FAIL_CLOSED",
            "GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_EXECUTION_READY",
        ],
        "blockers": blockers,
        ...
        "generic_supervised_paper_integrated_operation_final_readiness_audit_execution_ready": status == "PASS",
        "generic_integrated_operation_final_readiness_audit_execution_ready": status == "PASS",
        "generic_integrated_operation_final_readiness_audit_execution_model_ready": True,
        "generic_integrated_operation_final_readiness_audit_execution_patch_ready": True,
        "paper_integrated_operation_final_readiness_audit_execution_ready": status == "PASS",
        "integrated_operation_final_readiness_audit_execution_diagnostic_available": True,
        "integrated_operation_final_readiness_audit_execution_diagnostic_count": diagnostic_count,
        "generic_supervised_paper_integrated_operation_final_readiness_audit_execution_map": final_map,
        ...
        "would_run_postmortem": False,
        "would_run_lifecycle_completion_audit": False,
        "broker_submit_called_by_generic_integrated_operation_final_readiness_audit_execution": False,
        "broker_close_called_by_generic_integrated_operation_final_readiness_audit_execution": False,
        "telegram_network_send_called_by_generic_integrated_operation_final_readiness_audit_execution": False,
        "scheduler_started_by_generic_integrated_operation_final_readiness_audit_execution": False,
        "paper_state_modified_by_generic_integrated_operation_final_readiness_audit_execution": False,
        "paper_status_modified_by_generic_integrated_operation_final_readiness_audit_execution": False,
        "orders_submitted_by_generic_integrated_operation_final_readiness_audit_execution": 0,
        "orders_closed_by_generic_integrated_operation_final_readiness_audit_execution": 0,
        "positions_opened_by_generic_integrated_operation_final_readiness_audit_execution": 0,
        "positions_closed_by_generic_integrated_operation_final_readiness_audit_execution": 0,
...
def run_generic_supervised_paper_integrated_operation_final_readiness_audit_execution(settings: Settings | None = None) -> Dict[str, Any]:
    settings = settings or Settings()
    upstream_path = settings.data_path / "lsr_v2_generic_supervised_paper_integrated_operation_final_readiness_audit_execution_scaffold_report.json"
...
if __name__ == "__main__":
    payload = run_generic_supervised_paper_integrated_operation_final_readiness_audit_execution(Settings(project_root=Path(".")))
