"""Generic LSR-v2 supervised paper integrated operation terminal-ready synthesis execution.

29.4.4u-61 consumes the u-60 terminal-ready synthesis execution scaffold artifact and
models the next terminal-ready synthesis execution. This is a controlled execution
patch: it does not synthesize a terminal-ready runtime state, run integrated
...
PROMPT = "29.4.4u-61"
EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_TERMINAL_READY_SYNTHESIS_EXECUTION"
READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_TERMINAL_READY_SYNTHESIS_EXECUTION_READY"
KEEP_DIAGNOSTIC_DECISION = "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_TERMINAL_READY_SYNTHESIS_EXECUTION_NOT_READY"
U60_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_TERMINAL_READY_SYNTHESIS_EXECUTION_SCAFFOLD_READY"
...
TERMINAL_READY_SYNTHESIS_EXECUTION_STAGES: Tuple[str, ...] = (
    "load_generic_integrated_operation_terminal_ready_synthesis_execution_scaffold_report",
    "verify_integrated_operation_terminal_ready_synthesis_execution_scaffold_model_ready",
    "verify_integrated_operation_terminal_ready_synthesis_execution_scaffold_was_blocked",
    ...
    "verify_terminal_ready_synthesis_execution_patch_current_step_but_runtime_still_blocked",
    ...
    "map_integrated_operation_terminal_ready_synthesis_execution_gate",
    "publish_generic_integrated_operation_terminal_ready_synthesis_execution_artifact",
)

BLOCKED_UNTIL_TERMINAL_READY_SYNTHESIS_EXECUTION_PREREQUISITES: Tuple[str, ...] = (
...
REQUIRED_SOURCE_MARKERS: Tuple[Tuple[str, Tuple[str, ...]], ...] = (
    (
        ...
        (
            ...
            "generic_integrated_operation_terminal_ready_synthesis_execution_scaffold_ready",
        ),
    ),
...
class Settings:
    ...
    data_dir: str = "data"
    report_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_report.json"
    jsonl_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution.jsonl"
...
def _dry_run_payload(source: Mapping[str, Any]) -> Dict[str, Any]:
    source_map = _as_dict(source.get("generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_scaffold_map"))
...
def _build_terminal_ready_synthesis_execution_map(source: Mapping[str, Any], env: Mapping[str, str]) -> Dict[str, Any]:
    source_map = _as_dict(source.get("generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_scaffold_map"))
    gate_satisfied = {
    ...
    blocked_reasons = [
        "integrated_operation_terminal_ready_synthesis_execution_scaffold_not_allowed",
    ...
    gate_model: Dict[str, Any] = {
        "integrated_operation_terminal_ready_synthesis_execution_gate_model_ready": True,
        "integrated_operation_terminal_ready_synthesis_execution_model_ready": True,
        "integrated_operation_terminal_ready_synthesis_execution_patch_ready": True,
        "integrated_operation_terminal_ready_synthesis_execution_allowed": False,
        "integrated_operation_terminal_ready_synthesis_execution_conditions_satisfied": False,
        "integrated_operation_terminal_ready_synthesis_execution_scaffold_report_required": True,
        "integrated_operation_terminal_ready_synthesis_execution_scaffold_report_ready": source.get("decision") == U60_READY_DECISION,
        "integrated_operation_terminal_ready_synthesis_execution_scaffold_ready": bool(source.get("generic_integrated_operation_terminal_ready_synthesis_execution_scaffold_ready")),
        "integrated_operation_terminal_ready_synthesis_execution_scaffold_model_ready": bool(source.get("generic_integrated_operation_terminal_ready_synthesis_execution_scaffold_model_ready")),
        "integrated_operation_terminal_ready_synthesis_execution_scaffold_patch_ready": bool(source.get("generic_integrated_operation_terminal_ready_synthesis_execution_scaffold_patch_ready")),
        ...
        "integrated_operation_terminal_ready_synthesis_execution_blocked_reasons": blocked_reasons,
    }
    for key, satisfied in gate_satisfied.items():
        gate_model[key] = satisfied
        gate_model[key.replace("_satisfied", "_required")] = True
    context = {
        "blocked_reason": "integrated_operation_terminal_ready_synthesis_execution_blocked_until_complete_runtime_lifecycle_evidence_operator_gates_and_runtime_still_blocked",
        "generic_integrated_operation_terminal_ready_synthesis_execution_ready": True,
    ...
    return {
        "mode": "generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_controlled",
        "preflight_source": "29.4.4u-60",
        "read_only": True,
        ...
        "integrated_operation_terminal_ready_synthesis_execution_context": context,
        "integrated_operation_terminal_ready_synthesis_execution_gate_model": gate_model,
        "source_integrated_operation_terminal_ready_synthesis_execution_scaffold_map": source_map,
        ...
        "stages": [
            ...
            for stage in TERMINAL_READY_SYNTHESIS_EXECUTION_STAGES
        ],
    }


def run_generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution(
    ...
    upstream_path = data_path / "lsr_v2_generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_scaffold_report.json"
    ...
    if upstream is not None:
        not_ready_upstream = upstream.get("decision") != U60_READY_DECISION
    ...
    terminal_map = _build_terminal_ready_synthesis_execution_map(upstream, active_env)
    candidate_counts = _as_dict(upstream.get("candidate_detection_source_counts"))
    diagnostic_count = _safe_int(
        upstream.get(
            "integrated_operation_terminal_ready_synthesis_execution_scaffold_diagnostic_count",
    ...
    report: Dict[str, Any] = {
        ...
        "classification_labels": [
            ...
            "INTEGRATED_OPERATION_TERMINAL_READY_SYNTHESIS_EXECUTION_CONTROLLED",
            ...
            "NO_BROKER_CALL",
            "FAIL_CLOSED",
            "GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_TERMINAL_READY_SYNTHESIS_EXECUTION_READY",
        ],
        "blockers": blockers,
        ...
        "generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_ready": status == "PASS",
        "generic_integrated_operation_terminal_ready_synthesis_execution_ready": status == "PASS",
        "generic_integrated_operation_terminal_ready_synthesis_execution_model_ready": True,
        "generic_integrated_operation_terminal_ready_synthesis_execution_patch_ready": True,
        "paper_integrated_operation_terminal_ready_synthesis_execution_ready": status == "PASS",
        "paper_integrated_operation_terminal_ready": False,
        "integrated_operation_terminal_ready_synthesis_execution_diagnostic_available": True,
        "integrated_operation_terminal_ready_synthesis_execution_diagnostic_count": diagnostic_count,
        "blocked_until_runtime_integrated_operation_terminal_ready_synthesis_execution_prerequisites": list(BLOCKED_UNTIL_TERMINAL_READY_SYNTHESIS_EXECUTION_PREREQUISITES),
        "generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_map": terminal_map,
        ...
        "generic_integrated_operation_execution_allowed": False,
        "future_integrated_operation_allowed": False,
        "broker_submit_called_by_generic_integrated_operation_terminal_ready_synthesis_execution": False,
        "broker_close_called_by_generic_integrated_operation_terminal_ready_synthesis_execution": False,
        "orders_submitted_by_generic_integrated_operation_terminal_ready_synthesis_execution": 0,
        "orders_closed_by_generic_integrated_operation_terminal_ready_synthesis_execution": 0,
        "positions_opened_by_generic_integrated_operation_terminal_ready_synthesis_execution": 0,
        "positions_closed_by_generic_integrated_operation_terminal_ready_synthesis_execution": 0,
        "paper_state_modified_by_generic_integrated_operation_terminal_ready_synthesis_execution": False,
        "paper_status_modified_by_generic_integrated_operation_terminal_ready_synthesis_execution": False,
        "scheduler_started_by_generic_integrated_operation_terminal_ready_synthesis_execution": False,
        "telegram_network_send_called_by_generic_integrated_operation_terminal_ready_synthesis_execution": False,
        "would_run_integrated_operation_terminal_ready_synthesis": False,
...
__all__ = [
    ...
    "Settings",
    "run_generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution",
]
