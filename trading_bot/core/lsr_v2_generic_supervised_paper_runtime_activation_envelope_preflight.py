"""Generic LSR-v2 supervised paper runtime activation envelope preflight.

29.4.4u-62 consumes the u-61 terminal-ready synthesis execution artifact and
models a future runtime activation envelope preflight. The patch is preflight
only: it does not build or activate a runtime envelope, run integrated operation,
mutate paper_state or paper_status, send Telegram or network messages, start a
scheduler, call a broker, submit, close, or enable live/testnet/exchange access.

The preflight remains read-only by default and fail-closed. Complete runtime
lifecycle evidence, terminal-ready synthesis runtime, final-readiness-audit
handoff runtime, terminal lifecycle handoff runtime, scheduler/Telegram
completion runtime, broker receipts, runtime values, and all operator gates are
still required before any future runtime activation envelope execution.
"""
...
PROMPT = "29.4.4u-62"
EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ACTIVATION_ENVELOPE_PREFLIGHT"
READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ACTIVATION_ENVELOPE_PREFLIGHT_READY"
KEEP_DIAGNOSTIC_DECISION = "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_SUPERVISED_PAPER_RUNTIME_ACTIVATION_ENVELOPE_PREFLIGHT_NOT_READY"
U61_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_TERMINAL_READY_SYNTHESIS_EXECUTION_READY"
...
RUNTIME_ACTIVATION_ENVELOPE_PREFLIGHT_STAGES: Tuple[str, ...] = (
    "load_generic_integrated_operation_terminal_ready_synthesis_execution_report",
    "verify_terminal_ready_synthesis_execution_model_ready",
    "verify_terminal_ready_synthesis_execution_was_blocked",
    ...
    "verify_runtime_activation_envelope_requires_terminal_ready_runtime_evidence",
    ...
    "map_runtime_activation_envelope_preflight_gate",
    "publish_generic_runtime_activation_envelope_preflight_artifact",
)

BLOCKED_UNTIL_RUNTIME_ACTIVATION_ENVELOPE_PREFLIGHT_PREREQUISITES: Tuple[str, ...] = (
...
REQUIRED_SOURCE_MARKERS: Tuple[Tuple[str, Tuple[str, ...]], ...] = (
    (
        ...
        (
            "GENERIC_LSR_V2_SUPERVISED_PAPER_INTEGRATED_OPERATION_TERMINAL_READY_SYNTHESIS_EXECUTION",
            "generic_integrated_operation_terminal_ready_synthesis_execution_ready",
        ),
    ),
...
class Settings:
    ...
    data_dir: str = "data"
    report_name: str = "lsr_v2_generic_supervised_paper_runtime_activation_envelope_preflight_report.json"
    jsonl_name: str = "lsr_v2_generic_supervised_paper_runtime_activation_envelope_preflight.jsonl"
...
def _dry_run_payload(source: Mapping[str, Any]) -> Dict[str, Any]:
    source_map = _as_dict(source.get("generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_map"))
...
def _build_runtime_activation_envelope_preflight_map(source: Mapping[str, Any], env: Mapping[str, str]) -> Dict[str, Any]:
    source_map = _as_dict(source.get("generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_map"))
    blocked_reasons = [
        "integrated_operation_terminal_ready_synthesis_execution_not_allowed",
        "paper_integrated_operation_terminal_ready_not_ready",
    ...
    gate_model: Dict[str, Any] = {
        "runtime_activation_envelope_preflight_gate_model_ready": True,
        "runtime_activation_envelope_preflight_model_ready": True,
        "runtime_activation_envelope_preflight_patch_ready": True,
        "runtime_activation_envelope_preflight_allowed": False,
        "runtime_activation_envelope_preflight_conditions_satisfied": False,
        ...
        "integrated_operation_terminal_ready_synthesis_execution_report_required": True,
        "integrated_operation_terminal_ready_synthesis_execution_report_ready": source.get("decision") == U61_READY_DECISION,
        "integrated_operation_terminal_ready_synthesis_execution_ready": bool(source.get("generic_integrated_operation_terminal_ready_synthesis_execution_ready")),
        "integrated_operation_terminal_ready_synthesis_execution_model_ready": bool(source.get("generic_integrated_operation_terminal_ready_synthesis_execution_model_ready")),
        "integrated_operation_terminal_ready_synthesis_execution_patch_ready": bool(source.get("generic_integrated_operation_terminal_ready_synthesis_execution_patch_ready")),
        ...
        "runtime_activation_envelope_preflight_blocked_reasons": blocked_reasons,
        "scheduler_start_allowed_after_runtime_activation_envelope_preflight": False,
        "telegram_network_send_allowed_after_runtime_activation_envelope_preflight": False,
        "paper_state_mutation_allowed_after_runtime_activation_envelope_preflight": False,
        "paper_status_mutation_allowed_after_runtime_activation_envelope_preflight": False,
    ...
    return {
        "mode": "generic_supervised_paper_runtime_activation_envelope_preflight_only",
        "preflight_only": True,
        "preflight_source": "29.4.4u-61",
        "read_only": True,
        ...
        "source_integrated_operation_terminal_ready_synthesis_execution_map": source_map,
        "runtime_activation_envelope_preflight_context": {
            "blocked_reason": "runtime_activation_envelope_preflight_blocked_until_complete_runtime_lifecycle_evidence_operator_gates_and_explicit_envelope_execution_patch",
            "generic_runtime_activation_envelope_preflight_ready": True,
        ...
        "runtime_activation_envelope_preflight_gate_model": gate_model,
        "required_future_controls_before_runtime_activation_envelope_execution": {
            ...
            "terminal_ready_synthesis_execution_report_required": True,
        ...
        "stages": [
            ...
            for stage in RUNTIME_ACTIVATION_ENVELOPE_PREFLIGHT_STAGES
        ],
    }


def run_generic_supervised_paper_runtime_activation_envelope_preflight(settings: Settings | None = None) -> Dict[str, Any]:
    settings = settings or Settings()
    data_path = settings.data_path
    upstream_path = data_path / "lsr_v2_generic_supervised_paper_integrated_operation_terminal_ready_synthesis_execution_report.json"
    ...
    not_ready_upstream = bool(upstream) and upstream.get("decision") != U61_READY_DECISION
    if missing_upstream:
    ...
    envelope_map = _build_runtime_activation_envelope_preflight_map(upstream, active_env)
    candidate_counts = _as_dict(upstream.get("candidate_detection_source_counts"))
    diagnostic_count = _safe_int(
        upstream.get(
            "integrated_operation_terminal_ready_synthesis_execution_diagnostic_count",
    ...
    report: Dict[str, Any] = {
        ...
        "classification_labels": [
            ...
            "RUNTIME_ACTIVATION_ENVELOPE_PREFLIGHT_ONLY",
            ...
            "NO_BROKER_CALL",
            "FAIL_CLOSED",
            "GENERIC_SUPERVISED_PAPER_RUNTIME_ACTIVATION_ENVELOPE_PREFLIGHT_READY",
        ],
        "blockers": blockers,
        ...
        "generic_supervised_paper_runtime_activation_envelope_preflight_ready": status == "PASS",
        "generic_runtime_activation_envelope_preflight_ready": status == "PASS",
        "generic_runtime_activation_envelope_preflight_model_ready": True,
        "generic_runtime_activation_envelope_preflight_patch_ready": True,
        "paper_runtime_activation_envelope_preflight_ready": status == "PASS",
        "paper_runtime_activation_envelope_ready": False,
        "runtime_activation_envelope_preflight_diagnostic_available": True,
        "runtime_activation_envelope_preflight_diagnostic_count": diagnostic_count,
        "blocked_until_runtime_activation_envelope_preflight_prerequisites": list(BLOCKED_UNTIL_RUNTIME_ACTIVATION_ENVELOPE_PREFLIGHT_PREREQUISITES),
        "generic_supervised_paper_runtime_activation_envelope_preflight_map": envelope_map,
        ...
        "generic_integrated_operation_execution_allowed": False,
        "future_integrated_operation_allowed": False,
        "broker_submit_called_by_generic_runtime_activation_envelope_preflight": False,
        "broker_close_called_by_generic_runtime_activation_envelope_preflight": False,
        "orders_submitted_by_generic_runtime_activation_envelope_preflight": 0,
        "orders_closed_by_generic_runtime_activation_envelope_preflight": 0,
        "positions_opened_by_generic_runtime_activation_envelope_preflight": 0,
        "positions_closed_by_generic_runtime_activation_envelope_preflight": 0,
        "paper_state_modified_by_generic_runtime_activation_envelope_preflight": False,
        "paper_status_modified_by_generic_runtime_activation_envelope_preflight": False,
        "scheduler_started_by_generic_runtime_activation_envelope_preflight": False,
        "telegram_network_send_called_by_generic_runtime_activation_envelope_preflight": False,
        "would_build_runtime_activation_envelope": False,
        "would_run_runtime_activation_envelope": False,
