"""Generic LSR-v2 runtime snapshot footer/banner engine-runner adapter preflight.

29.4.4u-12 is intentionally read-only and fail-closed. It validates the
future adapter boundary between the read-only footer/banner wiring hook, the
Paper Engine, the paper runner, and the launcher surfaces. It never enables
...
PROMPT = "29.4.4u-12"
EVENT_TYPE = "LSR_V2_GENERIC_RUNTIME_SNAPSHOT_FOOTER_BANNER_ENGINE_RUNNER_ADAPTER_PREFLIGHT"
READY_DECISION = "LSR_V2_GENERIC_RUNTIME_SNAPSHOT_FOOTER_BANNER_ENGINE_RUNNER_ADAPTER_PREFLIGHT_READY"
KEEP_DIAGNOSTIC_DECISION = "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_RUNTIME_SNAPSHOT_FOOTER_BANNER_ENGINE_RUNNER_ADAPTER_PREFLIGHT_NOT_READY"
...
ADAPTER_PREFLIGHT_STAGES: Tuple[str, ...] = (
    ...
    "prepare_engine_read_only_adapter_contract",
    "prepare_runner_footer_adapter_contract",
    "prepare_launcher_banner_adapter_contract",
    "prepare_console_visibility_adapter_contract",
    "map_adapter_payload_bridge",
    "verify_engine_runner_launcher_adapter_parity",
    "prepare_future_engine_runner_adapter_wiring",
)

BLOCKED_UNTIL_EXPLICIT_ADAPTER_IMPLEMENTATION_PATCH: Tuple[str, ...] = (
    "engine_runner_adapter_activation",
...
class Settings:
    ...
    data_dir: str = "data"
    report_name: str = "lsr_v2_generic_runtime_snapshot_footer_banner_engine_runner_adapter_preflight_report.json"
    jsonl_name: str = "lsr_v2_generic_runtime_snapshot_footer_banner_engine_runner_adapter_preflight.jsonl"
...
def _build_adapter_map(read_only_payload: Mapping[str, Any], runtime_snapshot: Mapping[str, Any]) -> Dict[str, Any]:
    runner_payload = read_only_payload.get("runner_footer_payload", {}) if isinstance(read_only_payload.get("runner_footer_payload"), Mapping) else {}
    launcher_payload = read_only_payload.get("launcher_banner_payload", {}) if isinstance(read_only_payload.get("launcher_banner_payload"), Mapping) else {}
    console_payload = read_only_payload.get("console_visibility_payload", {}) if isinstance(read_only_payload.get("console_visibility_payload"), Mapping) else {}
    safety_payload = read_only_payload.get("safety_payload", {}) if isinstance(read_only_payload.get("safety_payload"), Mapping) else {}
    return {
        "mode": "engine_runner_adapter_preflight_only",
        "paper_only": True,
        ...
        "engine_adapter_enabled": False,
        "runner_adapter_enabled": False,
        "launcher_adapter_enabled": False,
        "console_adapter_enabled": False,
        "source_integration_points": {
            "footer_banner_read_only_wiring_hook": "core/lsr_v2_generic_runtime_snapshot_footer_banner_wiring_hook.py",
            "footer_banner_wiring_preflight": "core/lsr_v2_generic_runtime_snapshot_footer_banner_wiring_preflight.py",
            "runtime_snapshot_hook": "core/lsr_v2_generic_paper_cycle_runtime_snapshot_hook.py",
            "engine_hook_preflight": "core/lsr_v2_generic_paper_cycle_engine_hook_preflight.py",
            "runner_launcher_hook_preflight": "core/lsr_v2_generic_paper_cycle_runner_launcher_hook_preflight.py",
        ...
        "adapter_payload_bridge": {
            "runtime_snapshot_visible_read_only": _as_bool(read_only_payload.get("runtime_snapshot_visible_read_only", True)),
            "runtime_snapshot_sections": read_only_payload.get("runtime_snapshot_sections", runtime_snapshot.get("runtime_snapshot_sections", [])),
        ...
        "stages": [
            ...
            for stage in ADAPTER_PREFLIGHT_STAGES
        ],
    }


def run_generic_runtime_snapshot_footer_banner_engine_runner_adapter_preflight(
    ...
    read_only_payload = u11_report.get("generic_runtime_snapshot_footer_banner_read_only_wiring_payload", {})
    if not isinstance(read_only_payload, Mapping):
        read_only_payload = {}
    runtime_snapshot = u8_report.get("generic_runtime_snapshot", {})
    ...
    if route_candidate_available:
        blockers.append("route_candidate_present_unexpected_for_adapter_preflight")
    if paper_order_intent_ready:
        blockers.append("paper_order_intent_present_unexpected_for_adapter_preflight")

    ready = not blockers
    adapter_map = _build_adapter_map(read_only_payload, runtime_snapshot)
    ...
    payload: Dict[str, Any] = {
        ...
        "classification_labels": [
            "GENERIC_LSR_V2_RUNTIME_SNAPSHOT_FOOTER_BANNER_ENGINE_RUNNER_ADAPTER_PREFLIGHT",
            "READ_ONLY",
            ...
            "NO_SCHEDULER",
            "FAIL_CLOSED",
            "GENERIC_ENGINE_RUNNER_ADAPTER_PREFLIGHT_READY" if ready else "KEEP_DIAGNOSTIC",
        ],
        "blockers": blockers,
        "blocked_until_explicit_adapter_implementation_patch": list(BLOCKED_UNTIL_EXPLICIT_ADAPTER_IMPLEMENTATION_PATCH),
        "generic_runtime_snapshot_footer_banner_engine_runner_adapter_preflight_ready": ready,
        "generic_runtime_snapshot_footer_banner_engine_runner_adapter_plan_ready": ready,
        "generic_runtime_snapshot_footer_banner_engine_runner_adapter_contract_ready": ready,
        "generic_runtime_snapshot_footer_banner_engine_runner_adapter_map_ready": ready,
        "generic_runtime_snapshot_footer_banner_engine_runner_adapter_parity_ready": ready,
        "engine_read_only_adapter_preflight_ready": ready,
        "paper_runner_adapter_preflight_ready": ready,
        "launcher_adapter_preflight_ready": ready,
        "console_visibility_adapter_preflight_ready": ready,
        ...
        "runtime_snapshot_visible_read_only": _as_bool(u11_report.get("runtime_snapshot_visible_read_only", True)),
        ...
        "generic_runtime_snapshot_visibility_preflight_ready": _safe_upstream_bool(reports, "runtime_snapshot_visibility_preflight", "generic_runtime_snapshot_visibility_preflight_ready", True),
        ...
        "launcher_visibility_ready": _safe_upstream_bool(reports, "footer_banner_read_only_wiring_hook", "launcher_visibility_ready", True),
        "runner_visibility_ready": _safe_upstream_bool(reports, "footer_banner_read_only_wiring_hook", "runner_visibility_ready", True),
        "visibility_parity_ok": _safe_upstream_bool(reports, "footer_banner_read_only_wiring_hook", "visibility_parity_ok", True),
        "generic_engine_runner_adapter_required_markers_present": source_markers_present,
        "generic_engine_runner_adapter_source_files_present": not missing_source_files,
        "missing_engine_runner_adapter_source_files": missing_source_files,
        "missing_engine_runner_adapter_source_markers": missing_source_markers,
        ...
        "generic_engine_runner_adapter_map": adapter_map,
        "generic_runtime_snapshot_footer_banner_engine_runner_adapter_allowed": False,
        ...
        "broker_submit_called_by_engine_runner_adapter_preflight": False,
        "broker_close_called_by_engine_runner_adapter_preflight": False,
        "orders_submitted_by_engine_runner_adapter_preflight": 0,
        "positions_opened_by_engine_runner_adapter_preflight": 0,
        "positions_closed_by_engine_runner_adapter_preflight": 0,
        "paper_state_modified_by_engine_runner_adapter_preflight": False,
        "paper_status_modified_by_engine_runner_adapter_preflight": False,
        ...
        "required_readiness": {
            ...
            "engine_hook_preflight_ready": not ("lsr_v2_generic_paper_cycle_engine_hook_preflight_report.json" in missing_reports),
            "runner_launcher_hook_preflight_ready": not ("lsr_v2_generic_paper_cycle_runner_launcher_hook_preflight_report.json" in missing_reports),
        ...
        "next_step": "prepare_runtime_snapshot_footer_banner_engine_runner_adapter_read_only_hook_or_wait_for_real_candidate",
        "recommended_next_patch": "29.4.4u-13 — Generic LSR-v2 runtime snapshot footer/banner engine-runner read-only adapter hook",
        "settings": {
