"""Generic LSR-v2 supervised paper integrated operation final readiness audit handoff preflight.

29.4.4u-56 consumes the u-55 integrated operation final readiness audit
execution artifact and models the next handoff preflight gate. This patch is
handoff-preflight only: it does not hand off final-readiness-audit results,
run integrated operation, mutate paper_state or paper_status, send Telegram or
network messages, start a scheduler, call a broker, submit, close, or enable
live/testnet/exchange access.

The patch remains read-only by default and fail-closed. It only records whether
a future final-readiness-audit handoff could be modeled and why it is blocked
...
PROMPT = "29.4.4u-56"
EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_HANDOFF_PREFLIGHT"
READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_HANDOFF_PREFLIGHT_READY"
KEEP_DIAGNOSTIC_DECISION = "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_HANDOFF_PREFLIGHT_NOT_READY"
U55_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_EXECUTION_READY"
...
HANDOFF_PREFLIGHT_STAGES: Tuple[str, ...] = (
    "load_generic_integrated_operation_final_readiness_audit_execution_report",
    "verify_integrated_operation_final_readiness_audit_execution_model_ready",
    "verify_integrated_operation_final_readiness_audit_execution_was_blocked",
    ...
    "verify_future_final_readiness_audit_handoff_execution_patch_required",
    ...
    "map_integrated_operation_final_readiness_audit_handoff_preflight_gate",
    "publish_generic_integrated_operation_final_readiness_audit_handoff_preflight_artifact",
)

BLOCKED_UNTIL_HANDOFF_PREFLIGHT_PREREQUISITES: Tuple[str, ...] = (
    "integrated_operation_final_readiness_audit_handoff_execution_patch",
...
REQUIRED_SOURCE_MARKERS: Tuple[Tuple[str, Tuple[str, ...]], ...] = (
    (
        "trading_bot/core/lsr_v2_generic_supervised_paper_integrated_operation_final_readiness_audit_execution.py",
        (
            "GENERIC_LSR_V2_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_EXECUTION",
            "generic_integrated_operation_final_readiness_audit_execution_ready",
        ),
    ),
...
class Settings:
    ...
    data_dir: str = "data"
    report_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_final_readiness_audit_handoff_preflight_report.json"
    jsonl_name: str = "lsr_v2_generic_supervised_paper_integrated_operation_final_readiness_audit_handoff_preflight.jsonl"
...
def _build_handoff_preflight_map(upstream: Mapping[str, Any], active_env: Mapping[str, str]) -> Dict[str, Any]:
    source_map = _as_dict(upstream.get("generic_supervised_paper_integrated_operation_final_readiness_audit_execution_map"))
    source_gate = _as_dict(source_map.get("integrated_operation_final_readiness_audit_execution_gate_model"))
    dry_run_order_intent_payload = _as_dict(source_map.get("dry_run_order_intent_payload")) or _default_order_intent_payload()

    u55_report_ready = upstream.get("decision") == U55_READY_DECISION
    u55_ready = _bool_from_upstream(upstream, "generic_supervised_paper_integrated_operation_final_readiness_audit_execution_ready")
    u55_model_ready = _bool_from_upstream(upstream, "generic_integrated_operation_final_readiness_audit_execution_model_ready")
    u55_patch_ready = _bool_from_upstream(upstream, "generic_integrated_operation_final_readiness_audit_execution_patch_ready")
    u55_allowed = _bool_from_upstream(upstream, "generic_integrated_operation_final_readiness_audit_execution_allowed")
    ...
    gate_checks: Tuple[Tuple[bool, str], ...] = (
        (u55_report_ready, "integrated_operation_final_readiness_audit_execution_report_not_ready"),
        (u55_ready, "integrated_operation_final_readiness_audit_execution_not_ready"),
        (u55_model_ready, "integrated_operation_final_readiness_audit_execution_model_not_ready"),
        (u55_patch_ready, "integrated_operation_final_readiness_audit_execution_patch_not_ready"),
        (u55_allowed, "integrated_operation_final_readiness_audit_execution_not_allowed"),
        ...
        (False, "explicit_integrated_operation_final_readiness_audit_handoff_execution_patch_required"),
    )
    blocked_reasons = [reason for ok, reason in gate_checks if not ok]
    conditions_satisfied = not blocked_reasons

    gate_model = {
        "integrated_operation_final_readiness_audit_handoff_preflight_gate_model_ready": True,
        "integrated_operation_final_readiness_audit_handoff_preflight_model_ready": True,
        "integrated_operation_final_readiness_audit_handoff_preflight_patch_ready": True,
        "integrated_operation_final_readiness_audit_handoff_preflight_conditions_satisfied": conditions_satisfied,
        "integrated_operation_final_readiness_audit_handoff_preflight_allowed": False,
        ...
        "integrated_operation_final_readiness_audit_execution_report_required": True,
        "integrated_operation_final_readiness_audit_execution_report_ready": u55_report_ready,
        "integrated_operation_final_readiness_audit_execution_ready": u55_ready,
        "integrated_operation_final_readiness_audit_execution_model_ready": u55_model_ready,
        "integrated_operation_final_readiness_audit_execution_patch_ready": u55_patch_ready,
        "integrated_operation_final_readiness_audit_execution_allowed": u55_allowed,
        "integrated_operation_final_readiness_audit_handoff_preflight_blocked_reasons": blocked_reasons,
        ...
        "scheduler_start_allowed_after_integrated_operation_final_readiness_audit_handoff_preflight": False,
        "telegram_network_send_allowed_after_integrated_operation_final_readiness_audit_handoff_preflight": False,
        "paper_state_mutation_allowed_after_integrated_operation_final_readiness_audit_handoff_preflight": False,
        "paper_status_mutation_allowed_after_integrated_operation_final_readiness_audit_handoff_preflight": False,
    ...
    context = {
        "blocked_reason": "integrated_operation_final_readiness_audit_handoff_preflight_blocked_until_complete_runtime_lifecycle_evidence_operator_gates_and_explicit_handoff_execution_patch",
        "integrated_operation_final_readiness_audit_execution_ready": u55_report_ready and u55_ready and u55_model_ready,
        "generic_integrated_operation_final_readiness_audit_execution_allowed": u55_allowed,
        "generic_integrated_operation_final_readiness_audit_handoff_preflight_ready": True,
        "generic_integrated_operation_final_readiness_audit_handoff_preflight_allowed": False,
    ...
    return {
        "mode": "generic_supervised_paper_integrated_operation_final_readiness_audit_handoff_preflight_only",
        "read_only": True,
        ...
        "paper_only": True,
        "preflight_source": "29.4.4u-55",
        "source_integrated_operation_final_readiness_audit_execution_map": source_map,
        ...
        "integrated_operation_final_readiness_audit_handoff_preflight_context": context,
        "integrated_operation_final_readiness_audit_handoff_preflight_gate_model": gate_model,
        "required_future_controls_before_integrated_operation_final_readiness_audit_handoff_execution": {
            "integrated_operation_final_readiness_audit_execution_report_required": True,
            "explicit_generic_integrated_operation_final_readiness_audit_handoff_execution_patch_required": True,
...
def run_generic_supervised_paper_integrated_operation_final_readiness_audit_handoff_preflight(
    ...
    upstream_path = data_path / "lsr_v2_generic_supervised_paper_integrated_operation_final_readiness_audit_execution_report.json"
    ...
    if upstream is not None:
        not_ready_upstream = upstream.get("decision") != U55_READY_DECISION
    ...
    handoff_map = _build_handoff_preflight_map(upstream, active_env)
    ...
    report: Dict[str, Any] = {
        ...
        "classification_labels": [
            "GENERIC_LSR_V2_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_HANDOFF_PREFLIGHT",
            "INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_HANDOFF_PREFLIGHT_ONLY",
            ...
            "NO_BROKER_CALL",
            "FAIL_CLOSED",
            "GENERIC_SUPERVISED_PAPER_INTEGRATED_OPERATION_FINAL_READINESS_AUDIT_HANDOFF_PREFLIGHT_READY",
        ],
        "blockers": blockers,
        ...
        "generic_supervised_paper_integrated_operation_final_readiness_audit_handoff_preflight_ready": status == "PASS",
        "generic_integrated_operation_final_readiness_audit_handoff_preflight_ready": status == "PASS",
        "generic_integrated_operation_final_readiness_audit_handoff_preflight_model_ready": True,
        "generic_integrated_operation_final_readiness_audit_handoff_preflight_patch_ready": True,
        "paper_integrated_operation_final_readiness_audit_handoff_preflight_ready": status == "PASS",
        "integrated_operation_final_readiness_audit_handoff_preflight_diagnostic_available": True,
        "integrated_operation_final_readiness_audit_handoff_preflight_diagnostic_count": diagnostic_count,
        "blocked_until_runtime_integrated_operation_final_readiness_audit_handoff_preflight_prerequisites": list(BLOCKED_UNTIL_HANDOFF_PREFLIGHT_PREREQUISITES),
        "generic_supervised_paper_integrated_operation_final_readiness_audit_handoff_preflight_map": handoff_map,
        ...
        "generic_integrated_operation_execution_allowed": False,
        "future_integrated_operation_allowed": False,
        "broker_submit_called_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": False,
        "broker_close_called_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": False,
        "orders_submitted_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": 0,
        "orders_closed_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": 0,
        "positions_opened_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": 0,
        "positions_closed_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": 0,
        "paper_state_modified_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": False,
        "paper_status_modified_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": False,
        "telegram_network_send_called_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": False,
        "scheduler_started_by_generic_integrated_operation_final_readiness_audit_handoff_preflight": False,
