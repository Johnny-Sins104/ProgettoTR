"""Generic LSR-v2 supervised paper terminal lifecycle handoff execution scaffold.

29.4.4u-48 consumes u-47's terminal lifecycle handoff preflight artifact and
...
PROMPT = "29.4.4u-48"
EVENT_TYPE = "LSR_V2_GENERIC_SUPERVISED_PAPER_TERMINAL_LIFECYCLE_HANDOFF_EXECUTION_SCAFFOLD"
READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_TERMINAL_LIFECYCLE_HANDOFF_EXECUTION_SCAFFOLD_READY"
KEEP_DIAGNOSTIC_DECISION = "KEEP_DIAGNOSTIC_LSR_V2_GENERIC_SUPERVISED_PAPER_TERMINAL_LIFECYCLE_HANDOFF_EXECUTION_SCAFFOLD_NOT_READY"
U47_READY_DECISION = "LSR_V2_GENERIC_SUPERVISED_PAPER_TERMINAL_LIFECYCLE_HANDOFF_PREFLIGHT_READY"
...
TERMINAL_LIFECYCLE_HANDOFF_EXECUTION_SCAFFOLD_STAGES: Tuple[str, ...] = (
    "load_generic_terminal_lifecycle_handoff_preflight_report",
    "verify_terminal_lifecycle_handoff_preflight_model_ready",
    "verify_terminal_lifecycle_handoff_preflight_was_blocked",
    ...
    "map_terminal_lifecycle_handoff_execution_scaffold_gate",
    "publish_generic_terminal_lifecycle_handoff_execution_scaffold_artifact",
)
...
REQUIRED_SOURCE_MARKERS: Tuple[Tuple[str, Tuple[str, ...]], ...] = (
    (
        ...
        (
            ...
            "generic_terminal_lifecycle_handoff_preflight_ready",
        ),
    ),
...
class Settings:
    ...
    data_dir: str = "data"
    report_name: str = "lsr_v2_generic_supervised_paper_terminal_lifecycle_handoff_execution_scaffold_report.json"
    jsonl_name: str = "lsr_v2_generic_supervised_paper_terminal_lifecycle_handoff_execution_scaffold.jsonl"
...
def _build_terminal_lifecycle_handoff_execution_scaffold_map(
    u47_report: Mapping[str, Any], active_env: Mapping[str, str]
) -> Dict[str, Any]:
    source_map = _as_dict(u47_report.get("generic_supervised_paper_terminal_lifecycle_handoff_preflight_map", {}))
    source_gate = _as_dict(source_map.get("terminal_lifecycle_handoff_preflight_gate_model", {}))

    u47_report_ready = u47_report.get("generic_supervised_paper_terminal_lifecycle_handoff_preflight_ready") is True
    u47_model_ready = u47_report.get("generic_terminal_lifecycle_handoff_preflight_model_ready") is True
    u47_patch_ready = u47_report.get("generic_terminal_lifecycle_handoff_preflight_patch_ready") is True
    u47_gate_model_ready = source_gate.get("terminal_lifecycle_handoff_preflight_gate_model_ready") is True
    u47_conditions_satisfied = source_gate.get("terminal_lifecycle_handoff_preflight_conditions_satisfied") is True
    u47_allowed = source_gate.get("terminal_lifecycle_handoff_allowed") is True

    broker_submit_receipt = u47_report.get("broker_submit_receipt_available") is True
    broker_close_receipt = u47_report.get("broker_close_receipt_available") is True
    real_close_execution = u47_report.get("real_close_execution_available") is True
    paper_position_closed = u47_report.get("paper_position_closed") is True
    pnl_ready = u47_report.get("paper_realized_pnl_reconciliation_ready") is True
    pnl_written = u47_report.get("realized_pnl_written") is True
    final_audit_runtime = u47_report.get("final_audit_runtime_executed") is True
    postmortem_runtime = u47_report.get("postmortem_runtime_executed") is True
    lifecycle_completion_runtime = u47_report.get("lifecycle_completion_audit_runtime_executed") is True
    lifecycle_state_complete = u47_report.get("lifecycle_state_complete") is True
    paper_lifecycle_completion_ready = u47_report.get("paper_lifecycle_completion_ready") is True
    state_status_mutation_ready = u47_report.get("paper_lifecycle_state_status_completion_mutation_ready") is True
    terminal_handoff_ready = u47_report.get("paper_terminal_lifecycle_handoff_ready") is True
    ...
    conditions = [
        (u47_report_ready, "terminal_lifecycle_handoff_preflight_report_not_ready"),
        (u47_model_ready, "terminal_lifecycle_handoff_preflight_model_not_ready"),
        (u47_patch_ready, "terminal_lifecycle_handoff_preflight_patch_not_ready"),
        (u47_gate_model_ready, "terminal_lifecycle_handoff_preflight_gate_model_not_ready"),
        (u47_conditions_satisfied, "terminal_lifecycle_handoff_preflight_conditions_not_satisfied"),
        (u47_allowed, "terminal_lifecycle_handoff_preflight_not_allowed"),
        ...
        (False, "explicit_terminal_lifecycle_handoff_execution_patch_required"),
    ]
    ...
    gate_model = {
        ...
        "terminal_lifecycle_handoff_execution_scaffold_allowed": scaffold_allowed,
        "terminal_lifecycle_handoff_execution_scaffold_conditions_satisfied": scaffold_conditions_satisfied,
        "terminal_lifecycle_handoff_execution_scaffold_blocked_reasons": blocked_reasons,
        "terminal_lifecycle_handoff_preflight_report_required": True,
        "terminal_lifecycle_handoff_preflight_report_ready": u47_report_ready,
        "terminal_lifecycle_handoff_preflight_model_ready": u47_model_ready,
        "terminal_lifecycle_handoff_preflight_patch_ready": u47_patch_ready,
        "terminal_lifecycle_handoff_preflight_gate_model_ready": u47_gate_model_ready,
        "terminal_lifecycle_handoff_preflight_conditions_satisfied": u47_conditions_satisfied,
        "terminal_lifecycle_handoff_preflight_allowed": u47_allowed,
        "terminal_lifecycle_handoff_execution_patch_required": True,
        ...
        "runtime_values_required_before_terminal_lifecycle_handoff_execution_scaffold": True,
    ...
    context = {
        "blocked_reason": "terminal_lifecycle_handoff_execution_scaffold_blocked_until_complete_runtime_lifecycle_evidence_and_explicit_execution_patch",
        "generic_terminal_lifecycle_handoff_execution_scaffold_ready": True,
        "paper_terminal_lifecycle_handoff_execution_scaffold_ready": True,
        ...
        "paper_realized_pnl_reconciliation_ready": pnl_ready,
        "realized_pnl_written": pnl_written,
        "paper_final_audit_ready": u47_report.get("paper_final_audit_ready") is True,
        "paper_postmortem_ready": u47_report.get("paper_postmortem_ready") is True,
        "paper_lifecycle_completion_ready": paper_lifecycle_completion_ready,
        "paper_lifecycle_state_status_completion_mutation_ready": state_status_mutation_ready,
        "final_audit_runtime_executed": final_audit_runtime,
        "postmortem_runtime_executed": postmortem_runtime,
        "lifecycle_completion_audit_runtime_executed": lifecycle_completion_runtime,
        "lifecycle_state": u47_report.get("lifecycle_state", "FLAT_LOCKED"),
        "lifecycle_state_complete": lifecycle_state_complete,
    ...
    return {
        "mode": "generic_supervised_paper_terminal_lifecycle_handoff_execution_scaffold_only",
        "preflight_source": "29.4.4u-47",
        "paper_only": True,
        "read_only": True,
        ...
        "terminal_lifecycle_handoff_execution_scaffold_patch": True,
        "terminal_lifecycle_handoff_execution_scaffold_gate_model": gate_model,
        "terminal_lifecycle_handoff_execution_scaffold_context": context,
        "required_future_controls_before_terminal_lifecycle_handoff_execution_activation": {
            "explicit_generic_terminal_lifecycle_handoff_execution_patch_required": True,
            "terminal_lifecycle_handoff_preflight_report_required": True,
        ...
        "stages": [
            ...
            for stage in TERMINAL_LIFECYCLE_HANDOFF_EXECUTION_SCAFFOLD_STAGES
        ],
    }


def run_generic_supervised_paper_terminal_lifecycle_handoff_execution_scaffold(
    settings: Settings | None = None,
) -> Dict[str, Any]:
    settings = settings or Settings()
    data_path = settings.data_path
    active_env = _active_lsr_env()
    upstream_path = data_path / "lsr_v2_generic_supervised_paper_terminal_lifecycle_handoff_preflight_report.json"
    upstream = _read_json(upstream_path)
    upstream_present = bool(upstream)
    upstream_ready = upstream.get("decision") == U47_READY_DECISION and upstream.get(
        "generic_supervised_paper_terminal_lifecycle_handoff_preflight_ready"
    ) is True
    ...
    handoff_map = _build_terminal_lifecycle_handoff_execution_scaffold_map(upstream, active_env)
    gate = _as_dict(handoff_map.get("terminal_lifecycle_handoff_execution_scaffold_gate_model", {}))
    ...
    report: Dict[str, Any] = {
        ...
        "classification_labels": [
            ...
            "TERMINAL_LIFECYCLE_HANDOFF_EXECUTION_SCAFFOLD_ONLY",
            ...
            "NO_BROKER_CALL",
            "FAIL_CLOSED",
            "GENERIC_SUPERVISED_PAPER_TERMINAL_LIFECYCLE_HANDOFF_EXECUTION_SCAFFOLD_READY" if ready else "GENERIC_SUPERVISED_PAPER_TERMINAL_LIFECYCLE_HANDOFF_EXECUTION_SCAFFOLD_NOT_READY",
        ],
        "blockers": blockers,
        "generic_supervised_paper_terminal_lifecycle_handoff_execution_scaffold_ready": ready,
        "generic_terminal_lifecycle_handoff_execution_scaffold_ready": ready,
        "generic_terminal_lifecycle_handoff_execution_scaffold_model_ready": ready,
        "generic_terminal_lifecycle_handoff_execution_scaffold_patch_ready": ready,
        "paper_terminal_lifecycle_handoff_execution_scaffold_ready": ready,
        "terminal_lifecycle_handoff_execution_scaffold_diagnostic_available": diagnostic_available if ready else False,
        "terminal_lifecycle_handoff_execution_scaffold_diagnostic_count": diagnostic_count if ready else 0,
        ...
        "terminal_lifecycle_handoff_execution_scaffold_contract_required_fields": contract_required,
        "terminal_lifecycle_handoff_execution_scaffold_contract_present_fields": contract_present,
        "terminal_lifecycle_handoff_execution_scaffold_contract_missing_fields": contract_missing,
        "terminal_lifecycle_handoff_execution_scaffold_contract_shape_modelable": contract_shape_modelable,
        "generic_supervised_paper_terminal_lifecycle_handoff_execution_scaffold_map": handoff_map,
        ...
        "u47_terminal_lifecycle_handoff_preflight_report_present": upstream_present,
        "u47_terminal_lifecycle_handoff_preflight_ready": upstream_ready,
        "generic_terminal_lifecycle_handoff_preflight_ready": upstream.get("generic_terminal_lifecycle_handoff_preflight_ready") is True,
        "generic_terminal_lifecycle_handoff_preflight_model_ready": upstream.get("generic_terminal_lifecycle_handoff_preflight_model_ready") is True,
        "generic_terminal_lifecycle_handoff_preflight_patch_ready": upstream.get("generic_terminal_lifecycle_handoff_preflight_patch_ready") is True,
        ...
        "would_run_postmortem": False,
        "would_run_lifecycle_completion_audit": False,
        "orders_submitted_by_generic_terminal_lifecycle_handoff_execution_scaffold": 0,
        "orders_closed_by_generic_terminal_lifecycle_handoff_execution_scaffold": 0,
        "positions_opened_by_generic_terminal_lifecycle_handoff_execution_scaffold": 0,
        "positions_closed_by_generic_terminal_lifecycle_handoff_execution_scaffold": 0,
        "paper_state_modified_by_generic_terminal_lifecycle_handoff_execution_scaffold": False,
        "paper_status_modified_by_generic_terminal_lifecycle_handoff_execution_scaffold": False,
        "telegram_sent_by_generic_terminal_lifecycle_handoff_execution_scaffold": False,
        "scheduler_started_by_generic_terminal_lifecycle_handoff_execution_scaffold": False,
        ...
        "broker_submit_called_by_generic_terminal_lifecycle_handoff_execution_scaffold": False,
        "broker_close_called_by_generic_terminal_lifecycle_handoff_execution_scaffold": False,
        "live_enabled": False,
...
__all__ = [
    "READY_DECISION",
    "Settings",
    "run_generic_supervised_paper_terminal_lifecycle_handoff_execution_scaffold",
]
