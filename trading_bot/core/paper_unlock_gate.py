...
def evaluate_paper_unlock(
    *,
    ...
    if settings.profile != "BTC_ONLY_40_Q60":
        return PaperUnlockDecision(False, f"unsupported_profile:{settings.profile}", profile=settings.profile, symbol=symbol, tag=settings.tag)
