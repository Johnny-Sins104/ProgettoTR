...
def main() -> None:
    report = write_paper_unlock_shadow_dry_run_report("data")
    ...
    print(json.dumps({
        ...
        "report": report.get("files", {}).get("report", "data\\paper_unlock_shadow_dry_run_report.json") if isinstance(report.get("files"), dict) else "data\\paper_unlock_shadow_dry_run_report.json",
