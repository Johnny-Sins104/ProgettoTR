...
try:
    from core.lsr_v2_trade_lifecycle_auto_monitor import build_lsr_v2_trade_lifecycle_auto_monitor_report_from_files
except Exception:
    from trading_bot.core.lsr_v2_trade_lifecycle_auto_monitor import build_lsr_v2_trade_lifecycle_auto_monitor_report_from_files


def main() -> int:
    parser = argparse.ArgumentParser(description="LSR-v2 trade lifecycle auto monitor audit/update report")
    parser.add_argument("--data-dir", default="data")
    args = parser.parse_args()
    report = build_lsr_v2_trade_lifecycle_auto_monitor_report_from_files(data_dir=args.data_dir)
    keys = [
        "status",
        "decision",
        ...
        "telegram_lifecycle_message_key",
        "dashboard_ready",
        ...
        "orders_submitted_by_lifecycle_auto_monitor",
        "positions_opened_by_lifecycle_auto_monitor",
        "positions_closed_by_lifecycle_auto_monitor",
        "paper_state_modified_by_lifecycle_auto_monitor",
        "paper_status_modified_by_lifecycle_auto_monitor",
        "broker_submit_called_by_lifecycle_auto_monitor",
        "broker_close_called_by_lifecycle_auto_monitor",
        "live_enabled",
        "testnet_enabled",
