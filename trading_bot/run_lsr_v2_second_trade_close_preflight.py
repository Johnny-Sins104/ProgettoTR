...
try:
    from core.lsr_v2_second_trade_close_preflight import build_lsr_v2_second_trade_close_preflight_report_from_files
except Exception:
    from trading_bot.core.lsr_v2_second_trade_close_preflight import build_lsr_v2_second_trade_close_preflight_report_from_files


def main() -> int:
    parser = argparse.ArgumentParser(description="LSR-v2 second supervised paper close preflight / TP-hit close boundary")
    parser.add_argument("--data-dir", default="data")
    parser.add_argument("--cycle-id", default="")
    args = parser.parse_args()
    report = build_lsr_v2_second_trade_close_preflight_report_from_files(data_dir=args.data_dir, cycle_id=args.cycle_id)
    print(json.dumps({
        ...
        "open_second_lsr_v2_position_count": report.get("open_second_lsr_v2_position_count"),
        ...
        "orders_submitted_by_second_trade_close_preflight": report.get("orders_submitted_by_second_trade_close_preflight"),
        "positions_closed_by_second_trade_close_preflight": report.get("positions_closed_by_second_trade_close_preflight"),
        "positions_opened_by_second_trade_close_preflight": report.get("positions_opened_by_second_trade_close_preflight"),
